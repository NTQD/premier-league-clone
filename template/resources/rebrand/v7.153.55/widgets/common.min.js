...
(PULSE.app.templates.pagination =
    ...
    (e.addAriaClickListener = function (e, t) {
      ...
      (e.addMultiAriaClickListener = function (t, n) {
        ...
        Array.prototype.slice
          .call(t)
          .forEach((t) => e.addAriaClickListener(t, n, a, o));
      }),
      (e.removeAriaClickListener = function (e, t) {
        const o =
          arguments.length > 2 && void 0 !== arguments[2] && arguments[2]
            ? n.filter((e) => "click" !== e).concat(a)
            : n;
      ...
      (e.toggleZIndex = function (e) {
        ...
        for (let e = 0; e < a.length; e++) {
          ...
          t.style.hasClass(a[e], "js-no-keyboard-focus") ||
            (o && l(n)
              ? a[e].removeAttribute("tabindex")
              : o
              ? a[e].setAttribute("tabindex", "0")
              : a[e].setAttribute("tabindex", "-1"));
        }
      });
    const l = (e) => "a" === e,
      r = (e, t, n) => {
    ...
    const t = [],
      n = function (e) {
        ...
        for (let a = 0; a < t.length; a++)
          (n = t[a]),
            !n ||
              e.target === n.preventTriggerOn ||
              (n.preventTriggerOn && n.preventTriggerOn.contains(e.target)) ||
              n.element === e.target ||
              n.preventTriggerOn === e.target ||
              "function" != typeof n.callback ||
              n.callback(n.element);
      };
    e.closeOnOutsideClick = {
      addElement: function (e, a, o) {
        0 === t.length && document.addEventListener("click", n),
          t.push({ element: e, callback: a, preventTriggerOn: o });
      },
      removeElement: function (e) {
        for (let n = 0; n < t.length; n++)
          t[n] && t[n].element === e && t.splice(n, 1);
        0 === t.length && document.removeEventListener("click", n);
      },
    };
  })(PULSE.app.common),
  (function (e) {
    void 0 === e.constants && (e.constants = {}),
      (e.constants.VIDEO_JWT =
        "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NpZCI6IjI1MDg2ODkwMjUwMDEiLCJpYXQiOjE2ODkxNjEwODIsImV4cCI6MTY5MDg4NzYwMH0.CvBVzBqkXxtAXhMhGe3OkhL2b8PrZrw4AoOBuji-HVCGX8RHqrHOCxYfiprAlU-_m0gEt0ES60mImazeBa6UqsaDqoLy3eF8YJUeOvs6wY25HxpffSu-i0YR_-MOaTMGoFLuJbzzlIDhHqUPuxs4DMLrrgY8qy7sRExlEG-slTgAnwmu2PqeeOSZeyd6Z9g8DIBmZeaQ4uBHlTC5tJ7JkyNQcF8awe0Js95oCsiO-R3FurNrIQkguBWotVwWZDit6z6VL1olP7bXAU5HIJc0gChuwyOYIiaPnjNb4hdxLfZtycd6Bdlg7dhqo9JFwgp0Dw036ZBRP31WOby__BYL9Q"),
      (e.constants.API_RETRY_COUNT = 3),
      (e.constants.STATUS_CODES = {
        SUCCESS: 200,
        CREATED: 201,
        ACCEPTED: 202,
        REDIRECT: 300,
      ...
      (e.constants.EVENTS = {
        SCRIPTS: {
          COMMON: { LOADED: "COMMON_LOADED" },
          LIVE_BLOG: { LOADED: "LIVE_BLOG_LOADED" },
        },
      }),
      (e.constants.Search = { SEARCH_FIRED: "search.fired" }),
      (e.constants.footballMatchTimeline = {}),
      (e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS = {
        GOAL: "G",
        YELLOW_CARD: "Y",
        YELLOW_RED_CARD: "YR",
        RED_CARD: "R",
      ...
      (e.constants.footballMatchTimeline.EVENT_LABELS = {
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.GOAL]:
          "label.timeline.event.goal",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.YELLOW_CARD]:
          "label.timeline.event.yellowcard",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.YELLOW_RED_CARD]:
          "label.timeline.event.yellowred",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.RED_CARD]:
          "label.timeline.event.redcard",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.OWN_GOAL]:
          "label.timeline.event.owngoal",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.SUB_OFF]:
          "label.timeline.event.suboff",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.SUB_SIMPLE]:
          "label.timeline.event.sub",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.SUB_ON]:
          "label.timeline.event.subon",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.PENALTY]:
          "label.timeline.event.goal",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.PENALTY_MISSED]:
          "label.timeline.event.misspen",
        [e.constants.footballMatchTimeline.EVENT_DESCRIPTIONS.PENALTY_SAVED]:
          "label.timeline.event.misspen",
      }),
      ...
      (e.constants.clubColours = {
        t3: { colours: ["#ff0203", "#be000a"], inverted: !0 },
        t7: { colours: ["#7d1142", "#a6245f"] },
        t94: { colours: ["#ff1c24", "#c10000"], inverted: !0 },
        t36: { colours: ["#0054a6", "#1471cc"] },
        t91: { colours: ["#df1e26", "#af0c13"], inverted: !0 },
        t8: { colours: ["#2145f6", "#1934be"], inverted: !0 },
        t31: { colours: ["#0d5dba", "#093466"], inverted: !0 },
        t11: { colours: ["#00019e", "#3334b1"] },
        t54: { colours: ["#fff", "#e3e3e3"] },
        t2: { colours: ["#fff", "#e3e3e3"] },
        t13: { colours: ["#003090", "#0b56a4"], inverted: !0 },
        t14: { colours: ["#dc0714", "#911712"], inverted: !0 },
        t43: { colours: ["#98c5e9", "#6a9bc2"], inverted: !0 },
        t1: { colours: ["#ea0c0c", "#b40808"], inverted: !0 },
        t4: { colours: ["#444041", "#231f20"], inverted: !0 },
        t17: { colours: ["#d93d56", "#c2112e"], inverted: !0 },
        t20: { colours: ["#c80028", "#FC2651"], inverted: !0 },
        t6: { colours: ["#fff", "#e3e3e3"] },
        t21: { colours: ["#963849", "#6f2130"], inverted: !0 },
        t39: { colours: ["#f99808", "#ffca5e"], inverted: !0 },
        t49: { colours: ["#fa3844", "#e30613"] },
        t90: { colours: ["#81204c", "#500024"] },
        t102: { colours: ["#fa4616", "#de3c11"] },
        t40: { colours: ["#0333a0", "#0D4DDE"] },
      }),
      (e.constants.footballMatchTimeline.TIMELINE_PHASES_NORMAL = [
        e.constants.footballMatchTimeline.TIMELINE_PHASES[0],
        e.constants.footballMatchTimeline.TIMELINE_PHASES[1],
      ]),
      (e.constants.footballMatchTimeline.TIMELINE_PHASES_EXTRA = [
        e.constants.footballMatchTimeline.TIMELINE_PHASES[2],
        e.constants.footballMatchTimeline.TIMELINE_PHASES[3],
      ]),
      (e.constants.footballMatchTimeline.PHASE_ORDERING = [
        e.constants.footballMatchTimeline.TIMELINE_PHASE.FIRST_HALF,
        e.constants.footballMatchTimeline.TIMELINE_PHASE.HALF_TIME,
        e.constants.footballMatchTimeline.TIMELINE_PHASE.SECOND_HALF,
        e.constants.footballMatchTimeline.TIMELINE_PHASE.FIRST_HALF_EXTRA_TIME,
        e.constants.footballMatchTimeline.TIMELINE_PHASE.SECOND_HALF_EXTRA_TIME,
        e.constants.footballMatchTimeline.TIMELINE_PHASE.FULL_TIME,
      ]),
      (e.constants.dataCapture = {}),
      (e.constants.dataCapture.DEFAULT_FORM_ELEMENTS = [
        {
        ...
        },
        {
          elementType: "container",
          class:
            "data-capture-modal__opt-in-container js-club-opt-in-container",
          signedIn: !0,
        },
        {
          questionId: "terms",
      ...
      (e.constants.dataCapture.PL_MORNINGS_LIVE = {}),
      (e.constants.dataCapture.PL_MORNINGS_LIVE.FIELDS = [
        {
          elementType: "container",
        ...
        },
        {
          ...
          mandatory: !0,
          signedIn: !0,
          additionalProperties: { dropdownOptions: "0,1,2,3" },
      ...
      (e.constants.dataCapture.VALID_ACCESS_CODES = [
        "arsenal_plml_nsh",
        "bournemouth_plml_nsh",
        "brentford_plml_nsh",
        "brighton_plml_nsh",
        "burnley_plml_nsh",
        "chelsea_plml_nsh",
        "crystalpalace_plml_nsh",
        "everton_plml_nsh",
        "forest_plml_nsh",
        "fulham_plml_nsh",
        "luton_plml_nsh",
  ...
  (function (e, t) {
    ...
    (t.content.hasTag = function (e, t) {
      ...
      (t.content.videoIsBrightcove = function (e) {
        return (
          6101824271001 !== e.mediaId &&
          "brightcove" === e?.platform?.toLowerCase()
        );
      }),
      (t.content.getContentModel = function (e, n, o) {
        if ("photo" !== e.type) {
          const i = t.content.getImageFromContentItem(e);
          (e.mediaQueryConfig = a(i, n)),
            (e.link = t.generateContentUrl(e.type, e, o));
        } else
          (e.mediaQueryConfig = a(e, n)),
            e.playlist
              ? ((e.link = t.generateContentUrl(
                  e.playlist.type,
                  e.playlist,
                  "PHOTO"
                )),
      ...
      (t.content.getVariants = function (e) {
        ...
        if (t)
          if ("video" === t.type) {
            if (
              null !== t.thumbnail &&
              null !== t.thumbnail.variants &&
              t.thumbnail.variants.length > 0
            )
              return t.thumbnail.variants;
          } else if (null !== t.variants || t.variants.length > 0)
            return t.variants;
        return [];
      }),
      (t.content.getImageFromContentItem = function (e) {
        ...
        if ("photo" === e.type) t = e;
          ...
          "playlist" === e.type &&
            e.coverItem &&
            "playlist" === e.coverItem.type &&
            (n = e.coverItem.coverItem),
            n &&
              ("photo" === n.type
                ? (t = n)
                : "video" === n.type && n.thumbnail && (t = n.thumbnail));
        }
        return t;
      });
    const a = function (e, a) {
      if (e && e.onDemandUrl && Array.isArray(a))
        return a.map((a) => {
          let o = { ...a };
          const i = o.multipliers || n;
          return (
            (o.variantUrls = i.map((n) => {
    ...
    t.content.getTagExpression = function (e) {
  ...
  (function (e, t, n, a) {
    ...
    (e.momentGetDaysFromRange = function (e, n, o, i) {
      let l = e instanceof Date ? e : new Date(e),
        ...
        c = l.getTime();
      i &&
        l.toLocaleDateString() !== r.toLocaleDateString() &&
        s.push({
          date: l,
          string:
            a && o ? a(l).locale(t.language).format(o) : l.toLocaleDateString(),
      ...
      do {
        ...
        s.push({
          date: e,
          string:
            a && o ? a(e).locale(t.language).format(o) : e.toLocaleDateString(),
        ...
        if (e) {
          ...
          return o <= 0
            ? t
              ...
              : "just now"
            : o < i
            ? ((n = Math.round(o)), n + (t ? t.seconds : "s"))
            : o < 3600
            ? ((n = Math.round(o / i)), n + (t ? t.minutes : "m"))
            : o < 86400
            ? ((n = Math.round(o / 3600)), n + (t ? t.hours : "h"))
            : ((n = Math.round(o / 86400)), n + (t ? t.days : "d"));
        }
        return "";
      }),
  ...
  (PULSE.app.common.debounce = function (e) {
    let t,
  ...
  (function (e) {
    (e.icon = {}),
      (e.icon.renderSVG = function (e) {
        return `<svg class=${
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
            : "icon"
        }>\n                    <use class='icon' xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="${
          window.BASE_RESOURCE_URL
        }/${
          window.RESOURCE_VERSION
        }/i/elements/icons/${e}.svg"></use>\n                </svg>`;
      }),
      ...
      (e.icon.colouredBrandSVG = function (e) {
        return `<svg class="${
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
            : "svg-gradient"
        }" viewBox="${e}" xmlns="http://www.w3.org/2000/svg">\n                    <path d="M1476.18 343.773C1417.62 314.292 1359.88 282.402 1303.25 247.956H1370.01C1238.91 168.211 1113.73 74.8191 997.693 -33.3461H1053.33C1037.45 -48.144 1021.68 -63.1311 1006.15 -78.4882C930.279 -153.539 860.623 -232.469 797.157 -314.639H841.666C772.051 -404.776 709.962 -498.833 655.282 -595.941H688.664C637.256 -687.236 592.418 -781.22 554.223 -877.242H576.478C543.418 -960.341 515.278 -1044.94 492.109 -1130.61L520.117 -1158.54C554.586 -1062.74 595.542 -968.768 642.869 -877.242H620.615C670.679 -780.455 727.914 -686.422 792.377 -595.941H758.995C829.022 -497.649 907.547 -403.542 994.602 -314.639H950.093C959.003 -305.547 967.971 -296.487 977.054 -287.501C1073.1 -192.49 1175.92 -107.911 1283.7 -33.3378H1228.07C1356.01 55.1788 1490.99 129.53 1630.08 190.268L1476.18 343.781V343.773ZM1448.17 371.708C1309.06 310.97 1174.09 236.619 1046.15 148.102H1101.78C994.008 73.5283 891.194 -11.0503 795.138 -106.062C786.055 -115.047 777.079 -124.107 768.177 -133.199H812.686C725.63 -222.103 647.106 -316.21 577.079 -414.501H610.461C545.997 -504.982 488.763 -599.007 438.699 -695.803H460.953C413.618 -787.328 372.67 -881.304 338.201 -977.104L310.193 -949.169C333.362 -863.505 361.502 -778.901 394.562 -695.803H372.307C410.51 -599.78 455.349 -505.796 506.748 -414.501H473.366C528.046 -317.393 590.143 -223.336 659.75 -133.199H615.241C678.707 -51.0295 748.363 27.9094 824.233 102.952C839.762 118.309 855.529 133.296 871.412 148.094H815.776C931.82 256.25 1057 349.651 1188.1 429.395H1121.34C1177.97 463.842 1235.71 495.731 1294.26 525.212L1448.17 371.7V371.708ZM1812 8.81189C1672.89 -51.9257 1537.93 -126.277 1409.98 -214.794H1465.62C1357.84 -289.368 1255.03 -373.946 1158.97 -468.958C1149.89 -477.943 1140.91 -487.003 1132.01 -496.096H1176.52C1089.46 -584.999 1010.94 -679.105 940.911 -777.397H974.293C909.83 -867.878 852.595 -961.903 802.531 -1058.7H824.785C777.45 -1150.22 736.502 -1244.2 702.033 -1340L674.025 -1312.06C697.194 -1226.4 725.334 -1141.8 758.394 -1058.7H736.139C774.342 -962.676 819.181 -868.692 870.58 -777.397H837.198C891.878 -680.289 953.975 -586.232 1023.58 -496.096H979.073C1042.54 -413.926 1112.19 -334.987 1188.07 -259.944C1203.59 -244.587 1219.36 -229.6 1235.24 -214.802H1179.61C1295.65 -106.645 1420.83 -13.2455 1551.93 66.4993H1485.17C1541.8 100.946 1599.54 132.835 1658.09 162.316L1812 8.80359V8.81189ZM901.983 916.487C762.877 855.75 627.91 781.398 499.964 692.882H555.6C447.823 618.308 345.009 533.729 248.953 438.718C239.87 429.732 230.894 420.673 221.992 411.58H266.501C179.445 322.677 100.921 228.57 30.8943 130.279H64.2756C-0.187485 39.7971 -57.4221 -54.2277 -107.486 -151.023H-85.2316C-132.567 -242.548 -173.515 -336.524 -207.984 -432.324L-236 -404.381C-212.831 -318.717 -184.692 -234.114 -151.632 -151.015H-173.886C-135.683 -54.9922 -90.8447 38.9915 -39.4456 130.287H-72.827C-18.1475 227.395 43.9501 321.452 113.556 411.588H69.0479C132.514 493.758 202.169 572.697 278.04 647.74C293.568 663.097 309.336 678.084 325.219 692.882H269.583C385.627 801.038 510.803 894.438 641.905 974.183H575.142C631.775 1008.63 689.513 1040.52 748.066 1070L901.975 916.487H901.983ZM1265.81 553.592C1126.71 492.854 991.742 418.502 863.796 329.986H919.432C811.655 255.412 708.841 170.833 612.785 75.822C603.702 66.8364 594.726 57.7767 585.824 48.6842H630.333C543.277 -40.2189 464.753 -134.326 394.726 -232.617H428.108C363.645 -323.099 306.41 -417.124 256.346 -513.919H278.6C231.265 -605.444 190.317 -699.42 155.848 -795.22L127.84 -767.285C151.009 -681.621 179.149 -597.018 212.209 -513.919H189.954C228.157 -417.896 272.996 -323.913 324.395 -232.617H291.013C345.693 -135.51 407.79 -41.452 477.397 48.6842H432.888C496.354 130.854 566.01 209.793 641.88 284.835C657.409 300.192 673.176 315.18 689.059 329.978H633.424C749.467 438.134 874.643 531.534 1005.75 611.279H938.983C995.616 645.725 1053.35 677.615 1111.91 707.096L1265.81 553.583V553.592ZM1083.9 735.04C944.793 674.302 809.826 599.95 681.88 511.434H737.516C629.739 436.86 526.925 352.281 430.869 257.27C421.786 248.284 412.81 239.225 403.908 230.132H448.417C361.361 141.229 282.837 47.1221 212.81 -51.1694H246.192C181.729 -141.651 124.494 -235.676 74.4301 -332.471H96.6844C49.3488 -423.996 8.401 -517.972 -26.0683 -613.772L-54.0757 -585.837C-30.9066 -500.173 -2.76733 -415.57 30.2926 -332.471H8.03833C46.2414 -236.448 91.0796 -142.465 142.479 -51.1694H109.097C163.777 45.9382 225.874 139.996 295.481 230.132H250.972C314.438 312.302 384.094 391.241 459.964 466.283C475.493 481.641 491.26 496.627 507.143 511.425H451.508C567.551 619.582 692.727 712.982 823.829 792.727H757.067C813.699 827.173 871.437 859.063 929.99 888.544L1083.9 735.031V735.04Z" />\n                </svg>`;
      });
  })(PULSE.app.common),
  (function (e, t) {
    (t.getEventTypeClass = function (e) {
      ...
      (t.getTeamModel = function (e, t) {
        let n = {};
        return (
          e.team && e.team.club && e.team.club.shortName
            ? (n.name = e.team.club.shortName)
            : (n.name = e.team.name),
          e.team &&
            e.team.club &&
            (e.team.club.abbr
      ...
      (t.getPlayerForType = function (e, n, a, o) {
        ...
        return (
          ...
          "Y" !== n.description &&
            ("P" === n.description
              ? (l += " (pen)")
              : "O" === n.description && (l += " (og)"),
            e[a][o] || (e[a][o] = []),
            e[a][o].push({ label: l, val: i })),
          e
        );
      }),
            ...
            e.forEach(function (e) {
              if (
                ...
                if (
                  ("P" === c && (c = "G"),
                  !!(
                    !!(a && a[e.personId] && a[e.personId][c]) &&
                    a[e.personId][c].length > 0 &&
                    a[e.personId][c][0].val === e.clock.secs
                  ) && !("Y" === c && a[e.personId].YR))
                ) {
                  var i = 0;
                  ...
                  if (l) {
                    ...
                    o.matchEvents[i].push({
                      ...
                      playerShortName:
                        l.name.first.substring(0, 1) + ". " + l.name.last,
                      playerUrl: t.generateUrl(
                        "player",
                        l.id,
                        "",
                        l.name.display.replace(new RegExp(" ", "g"), "-")
                      ),
                      eventTimes: r,
                    });
                  }
                ...
                let d =
                  !!(
                    ...
                    a[e.assistId] &&
                    a[e.assistId].AS &&
                    a[e.assistId].AS.length > 0
                  ) && a[e.assistId].AS[0].val === e.clock.secs;
                e.teamId &&
                  "G" === e.description &&
                  e.assistId &&
                  d &&
                  ((i = 0),
                  n[1].teamId === e.teamId && (i = 1),
                  (l = t.getPlayerForEvent(n, e.assistId)) &&
                    ((r =
                      " " +
                      a[e.assistId].AS.map(function (e) {
                        return e.label;
                      }).join(",") +
                      " "),
                    o.assists[i].push({
      ...
      (t.match = {}),
      (t.match.getTeamAbbreviation = function () {
        let e =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        return e && e.club && e.club.abbr
          ? e.club.abbr
          : PULSE.I18N.lookup("label.team.tbc");
      }),
        ...
        let e =
          ...
          t =
            arguments.length > 1 && void 0 !== arguments[1]
              ? arguments[1]
              : "HH:mm";
        return e.kickoff && e.kickoff.millis
          ? moment(e.kickoff.millis).format(t)
          : e.provisionalKickoff && e.provisionalKickoff.millis
          ? moment(e.provisionalKickoff).format(t)
          : PULSE.I18N.lookup("label.time.tbc");
      }),
      (t.match.getPenaltiesString = function () {
        let e =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          t = arguments.length > 1 ? arguments[1] : void 0;
        const { shootout: n, penaltyShootouts: a } = e;
      ...
      (t.match.getAggregateScore = function (e) {
        if (
          !e ||
          !e.aggregateDetails ||
          !e.aggregateDetails.legs.length ||
          e.fixtureType !== t.constants.footballFixtureType.SECOND_LEG
        )
          return;
    ...
    (t.match.groupFunctions = {
      byDay: (e) => {
        return (
          (n = t.match.getFormattedMatchDateTime(e, "")),
          moment(n).startOf("day").unix()
        );
        var n;
      },
      byMonth: (e) => {
      ...
      (t.match.groupMatches = function () {
        let e =
          ...
          n =
            arguments.length > 1 && void 0 !== arguments[1]
              ? arguments[1]
              : t.match.groupFunctions.byMonth,
          a =
            arguments.length > 2 && void 0 !== arguments[2]
              ? arguments[2]
              : t.constants.footballOrderMapping.ASCENDING;
        const o = { mapping: {}, iterationOrder: [] };
        ...
        if (
          t.constants.footballOrderMapping[a] ===
          t.constants.footballOrderMapping.ASCENDING
        )
          o.iterationOrder = i.sort();
      ...
      (t.match.getRenderModel = function (e) {
        const {
          ...
          l = e.gameweek.compSeason.competition;
        return {
          status: e.status,
          ...
          formattedMatchDateTime: t.match.getFormattedMatchDateTime(
            e,
            "DD MM YYYY"
          ),
          finalScoreModel: {
  ...
  (function (e, t) {
    (t.metadata = {}),
      (t.metadata.setTitles = function (e) {
        if (!e) return;
      ...
      (t.metadata.setDescriptions = function (e) {
        ...
        let t = document.head.querySelector('meta[name="description"]') || null,
          ...
          a =
            ...
            null;
        t &&
          t.getAttribute("content") !== e &&
          (t.setAttribute("content", e),
          n && n.setAttribute("content", e),
          a && a.setAttribute("content", e));
      });
  })(PULSE.app, PULSE.app.common),
  (PULSE.app.common.prepareParams = function () {
    ...
    for (let n in e)
      if (e.hasOwnProperty(n)) {
        ...
        if (void 0 === a) {
          console.warn(
            `Value for '${n}' in object 'params' was undefined. The key '${n}' has been omitted from the query string. Please be explicit with values, e.g. boolean or empty string`
          );
          continue;
        }
  ...
  (function (e) {
    void 0 === e.security && (e.security = {}),
      (e.security.sanitize = (e) => e.replace(/(&|<|"|\/|>|\(|\)|;)/g, ""));
  })(PULSE.app.common),
  (function (e) {
    (e.template = {}),
      (e.template.cleanString = function (e) {
      ...
      (e.template.getSourceConfig = function (e) {
        let t = "";
        t =
          e.variantUrls.length > 1
            ? `${e.variantUrls.join(", ")} 2x`
            : e.variantUrls.join("");
        let n = [];
        return (
          void 0 !== e.minWidth && n.push(`(min-width: ${e.minWidth}px)`),
          void 0 !== e.maxWidth && n.push(`(max-width: ${e.maxWidth}px)`),
          { srcset: t, mediaQuery: n.join(" and ") }
        );
      }),
  ...
  (function (e, t) {
    (t.urlHelpers = {}),
      (t.urlHelpers.removeURLParam = function (e) {
  ...
  (function (e, t, n) {
    ...
    (t.createApiPath = function (t, a) {
      ...
      for (let e in a)
        o.indexOf("{" + e + "}") > -1
          ? (o = o.replace("{" + e + "}", a[e]))
          : void 0 !== a[e] && null !== a[e] && i.push(e + "=" + a[e]);
      ...
      (t.generateContentUrl = function (t, n, a, o) {
        ...
        switch ((a && (a = a.replace(" ", "-")), t)) {
          ...
          case "player":
            return (
              i + "/players/" + n + "/" + (a = a || "player") + "/overview"
            );
          case "club":
          case "team":
      ...
      (t.getMatchCentreUrl = function (n, a) {
        if ((a = a || n.gameweek.compSeason)) {
          let l;
          if (
            "U21" === a.competition.level &&
            e.statCompSeasons.U21.indexOf(a.id) > -1
          )
            return (
              (l = ["premier-league-2", o(a), i(n)].join("/").toLowerCase()),
              t.generateContentUrl("match", n.id, l)
            );
          if (
            "U18" === a.competition.level &&
            e.statCompSeasons.U18.indexOf(a.id) > -1
          )
            return (
              (l = ["u18-premier-league", o(a), i(n)].join("/").toLowerCase()),
              t.generateContentUrl("match", n.id, l)
            );
          if (
            "U21" !== a.competition.level &&
            "U18" !== a.competition.level &&
            e.competitionMatchCentres.indexOf(a.competition.id) > -1
          )
            return t.generateContentUrl("match", n.id);
        }
        return "";
      });
    const o = function (e) {
      ...
      i = function (e) {
        ...
        if (e.teams && 2 === e.teams.length) {
          ...
          e.teams[0] && e.teams[0].team
            ? (t += e.teams[0].team.shortName || e.teams[0].team.name)
            : (t += n),
            (t += "-v-"),
            e.teams[1] && e.teams[1].team
              ? (t += e.teams[1].team.shortName || e.teams[1].team.name)
              : (t += n);
        }
  ...
  (function (e, t) {
    (t.widget = {}),
      (t.widget.getNumberAttribute = function (e, t) {
  ...
  (function (e) {
    ...
    e.endpoints.football = {
      ...
      competition: {
        ...
        current: (e, n) =>
          `/football/competitions/${e}/compseasons/current${t(n)}`,
      },
      competitionSeason: {
        ...
        gameweeks: {
          ...
          single: (e, n, a) =>
            `/football/compseasons/${e}/gameweeks/${n}${t(a)}`,
          current: (e, n) =>
            `/football/compseasons/${e}/gameweeks/current${t(n)}`,
          events: {
            single: (e, n, a) =>
              `/football/compseasons/${e}/gameweeks/${n}/events${t(a)}`,
            current: (e, n) =>
              `/football/compseasons/${e}/gameweeks/current/events${t(n)}`,
          },
          fixtures: (e, n) =>
            `/football/compseasons/${e}/gameweeks/current/fixtures${t(n)}`,
        },
        standings: {
          all: (e, n) => `/football/compseasons/${e}/standings${t(n)}`,
          team: (e, n, a) =>
            `/football/compseasons/${e}/standings/team/{teamId}${t(a)}`,
        },
        structure: (e) => `/football/compseasons/${e}/structure`,
        teams: {
          all: (e, n) => `/football/compseasons/${e}/teams${t(n)}`,
          single: (e, n, a) =>
            `/football/compseasons/${e}/teams/{teamId}${t(a)}`,
          performance: (e, n, a) =>
            `/football/compseasons/${e}/teams/{teamId}/performance${t(a)}`,
        },
      },
      fixtures: {
        ...
        textstream: (e, n, a) =>
          `/football/fixtures/${e}/textstream/${n}${t(a)}`,
      },
      gameweeks: { single: (e, n) => `/football/gameweeks/${e}${t(n)}` },
      grounds: {
      ...
      season: { all: (e) => `/football/seasons${t(e)}` },
      standings: { all: (e) => `/football/standings${t(e)}` },
      stats: {
      ...
      teams: {
        ...
        single: {
          ...
          staff: (e, n, a) =>
            `/football/teams/${e}/compseasons/${n}/staff${t(a)}`,
          stats: (e, n, a) =>
            `/football/teams/${e}/compseasons/${n}/stats${t(a)}`,
          seasonStaff: (e, n, a) =>
            `/football/teams/${e}/seasons/${n}/staff${t(a)}`,
        },
      },
      teamOfficials: {
      ...
      broadcastingSchedule: {
        ...
        single: (e, n) =>
          `/football/broadcasting-schedule/fixtures/${e}${t(n)}`,
        highlights: (e) =>
          `/football/broadcasting-schedule/highlights-programs${t(e)}`,
      },
      matchOfficials: {
  ...
  (function (e) {
    (e.redux.initialState = {}),
      (e.redux.createActionCreator = (e) => (t) => ({ type: e, payload: t })),
      (e.redux.createSignalAction = (t, n) => ({
        REQUEST: `SIGNAL/${t}/${n}/REQUEST`,
        SUCCESS: `SIGNAL/${t}/${n}/SUCCESS`,
        FAILURE: `SIGNAL/${t}/${n}/FAILURE`,
        request: e.redux.createActionCreator(`SIGNAL/${t}/${n}/REQUEST`),
        success: e.redux.createActionCreator(`SIGNAL/${t}/${n}/SUCCESS`),
        failure: e.redux.createActionCreator(`SIGNAL/${t}/${n}/FAILURE`),
      })),
      (e.redux.createDeltaAction = (e, t) => `DELTA/${e}/${t}`),
      (e.redux.createWatcher = (e, t) =>
        function* () {
          for (;;) {
            const { data: n } = yield ReduxSaga.effects.take(e);
            yield ReduxSaga.effects.fork(t, n);
          }
        }),
      (e.redux.getNestedItemFromPath = function (e, t) {
        if (0 === e.length) return null;
        let n = t;
        for (let t = 0; t < e.length; t++) {
          if (void 0 === n[e[t]] || null === n[e[t]]) return null;
          n = n[e[t]];
        }
        return n;
      });
    e.redux.watch = function (t, n) {
      let a = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
        o =
      ...
      a &&
        n(
          e.redux.getNestedItemFromPath(t, e.redux.store.getState()),
          e.redux.getNestedItemFromPath(t, e.redux.store.getState()),
          t
        );
      const i = (function (t, n, a) {
        let o = e.redux.getNestedItemFromPath(n, t());
        return function (i) {
          return function () {
            const l = e.redux.getNestedItemFromPath(n, t());
            if (!a(o, l)) {
              const e = o;
              (o = l), i(l, e, n);
            }
      ...
      })(e.redux.store.getState, t, o);
      return e.redux.store.subscribe(
        i((e, t, a) => {
          n(e, t, a);
        })
      );
  ...
  (function (e, t, n, a) {
    let o = function (e, t) {
      if (e && e.length > 0)
        for (let n = 0; n < e.length; n++)
          if (e[n].fixture && e[n].fixture.id && e[n].fixture.id == t)
            return e[n];
    };
    (e.getBroadcasters = function (e, t, n) {
      ...
      (a.element = e),
        (a.config = t || {}),
        (a.multipleBroadcastersModals = []),
        (a.thisCountry = a.element.getAttribute("data-location") || "");
      let o = t.containerClass ? t.containerClass : "mcNavBroadcasterContainer";
      (a.template = t.template ? t.template : "commonmatchbroadcaster"),
        (a.matchBroadcasterContainer = a.element.getElementsByClassName(o));
      let i = [],
      ...
      if (n && n.hideBroadcasters) a.setListeners();
        ...
        for (let e = 0; e < a.matchBroadcasterContainer.length; e++) {
          ...
          t && -1 === i.indexOf(t) && i.push(t),
            a.matchBroadcasterContainer[e].getAttribute("data-comp") &&
              (l = a.matchBroadcasterContainer[e].getAttribute("data-comp"));
        }
        (a.urlConfig = (function (e, t, n) {
          return (
            (n = n || {}).pageSize || (n.pageSize = 100),
            n.fixtureIds || (n.fixtureIds = e),
            n.comps || (n.comps = t),
            n
          );
        })(i, l, n)),
          a.urlConfig.fixtureIds.length > 0 && a.initBroadcastData(a.urlConfig),
          a.setListeners();
      }
    }),
      ...
      (e.getBroadcasters.prototype.renderBroadcastingSchedule = function (n) {
        ...
        if (
          ...
          n.content &&
          n.content.length > 0 &&
          i.matchBroadcasterContainer
        ) {
          i.liveStreaming || (i.liveStreaming = new t.liveStreaming(i.element)),
            (i.thisCountry =
              n && n.countryCode ? n.countryCode : i.thisCountry);
          let l = e.removeRadioBroadcasters(n.content);
          i.liveStreaming.saveStreamingURLs(l, i.thisCountry),
            i.saveBroadcastModals(l);
          for (let n = 0; n < i.matchBroadcasterContainer.length; n++) {
            let r = o(
              l,
              i.matchBroadcasterContainer[n].getAttribute("data-id")
            );
            if (r && r.broadcasters && r.broadcasters.length > 0) {
              let o = i.liveStreaming.getFixturesStreamingURLs(
                  r.fixture.id,
                  r.fixture.kickoff.millis
                ),
                l = {
              ...
              for (let t = 0; t < l.broadcasters.length; t++) {
                ...
                (n.liveStreaming = i.liveStreaming.getLiveStreamData(
                  n,
                  l.fixtureHasLiveStream
                )),
                  (n.logoSrc = e.getBroadcasterLogo(n.abbreviation, "global")),
                  (n.logoSrcRetina = e.getBroadcasterLogo(
                    n.abbreviation,
                    "global",
                    !0
                  ));
              }
              r.broadcasters.length > 2 &&
                (l.multipleBroadcasters = a.lookup(
                  "label.multiplebroadcasters"
                )),
                (i.matchBroadcasterContainer[n].innerHTML = Mustache.render(
                  t.templates[i.template],
                  l
                )),
                new t.broadcasterLogo(i.matchBroadcasterContainer[n], !0);
            }
          }
      ...
      (e.getBroadcasters.prototype.saveBroadcastModals = function (e) {
        ...
        for (let o = 0; o < a; o++) {
          ...
          if (a.broadcasters.length > 2) {
            let e = n.liveStreaming.getFixturesStreamingURLs(
                i,
                a.fixture.kickoff.millis
              ),
      ...
      (e.getBroadcasters.prototype.setListeners = function () {
        ...
        this.element.addEventListener("click", t.redirectToMatchCenter),
          this.element.addEventListener("keypress", t.redirectToMatchCenter);
      });
  ...
  (function (e, t, n, a) {
    let o = function (e) {
        ...
        ("keypress" === t && 13 !== a) ||
          (this.update(), n.style.addClass(this.broadcastModal[0], "open"));
      },
      i = function (e) {
        let t = e.type,
          a = e.keyCode || e.charCode;
        (("keypress" !== t && "keyup" !== t) || 27 === a) &&
          l.call(this) &&
          n.style.removeClass(this.broadcastModal[0], "open");
      },
      l = function () {
    ...
    (e.multipleBroadcastersModal = function (e, t, n) {
      ...
      (a.liveStreams = t || []),
        (a.broadcastData = e),
        (a.broadcastModal =
          document.getElementsByClassName("plBroadcastModal")),
        (a.broadcastModalClose = document.getElementsByClassName(
          "broadcastModalCloseButton"
        )),
        (a.jsButtonClass = "js-multipleBroadcasters"),
        void 0 !== n && (a.jsButtonClass += "-" + n);
    }),
      (e.multipleBroadcastersModal.prototype.init = function () {
        let e = this;
        (e.modalOpener = document.getElementsByClassName(e.jsButtonClass)),
          0 !== e.broadcastModal.length &&
            0 !== e.broadcastModalClose.length &&
            0 !== e.modalOpener.length &&
            (e.broadcastModalClose[0].addEventListener("click", i.bind(e)),
            e.broadcastModalClose[0].addEventListener("keypress", i.bind(e)),
            e.broadcastModal[0].addEventListener("keyup", i.bind(e)),
            Array.prototype.map.call(e.modalOpener, function (t) {
              t.addEventListener("click", o.bind(e)),
                t.addEventListener("keypress", o.bind(e));
            }),
      ...
      (e.multipleBroadcastersModal.prototype.updateModel = function () {
        ...
        return e.broadcastData.map(function (t) {
          let n = t.name.split("-");
          return (
            (n = n.length > 1 ? n[1].trim() : n[0].trim()),
            (t.name = n),
            (t.liveStreaming = e.getLiveStreamData(t)),
            (t.logoSrc = a.getBroadcasterLogo(t.abbreviation, "large")),
            (t.logoSrcRetina = a.getBroadcasterLogo(
              t.abbreviation,
              "large",
              !0
            )),
      ...
      (e.multipleBroadcastersModal.prototype.update = function () {
        let n = this,
          ...
          i = n.broadcastModal[0].getElementsByClassName(
            "allBroadcastersModalContainer"
          );
        if (0 === i.length || !n.broadcastData || 0 === n.broadcastData.length)
          return;
        let l = n.updateModel();
  ...
  (function (e) {
    (e.filterDropdownDelegate = function () {}),
      (e.filterDropdownDelegate.prototype.didUpdate = function (e) {}),
      (e.filterDropdownDelegate.prototype.didFinishUpdate = function (e) {}),
      (e.filterDropdownDelegate.prototype.didClear = function (e) {}),
      (e.filterDropdownDelegate.prototype.didOpen = function (e) {}),
      (e.filterDropdownDelegate.prototype.didClose = function (e) {}),
      (e.filterDropdownDelegate.prototype.didOptionSelect = function (e) {});
  })(PULSE.app.common),
  (function (e) {
    (e.filterControllerDelegate = function () {}),
      (e.filterControllerDelegate.prototype.filterCleared = function () {}),
      (e.filterControllerDelegate.prototype.dropDownOpened = function () {}),
      (e.filterControllerDelegate.prototype.dropDownOptionSelected =
        function () {}),
      (e.filterControllerDelegate.prototype.filterUpdated = function (e) {});
  })(PULSE.app.common),
  (function (e, t, n, a, o) {
    let i = function (e, i) {
        i.label && (i.label = o.lookup("label." + i.label)),
          i.mobileLabel && (i.mobileLabel = o.lookup("label." + i.mobileLabel)),
          i.defaultOption &&
            (i.defaultOption = o.lookup("label." + i.defaultOption)),
          i.data &&
            i.data.length > 0 &&
            i.data.map(function (e) {
              e.optionLabel &&
                (e.optionName = o.lookup("label." + e.optionLabel));
            }),
          a.dom.appendDomString(
            e.container,
            Mustache.render(n.listfilter, {
              dropdown: i,
          ...
          (e.element = e.container.querySelector(
            '[data-dropdown-block="' + e.config.name + '"]'
          )),
          (e.current = e.container.querySelector(
            '[data-dropdown-current="' + e.config.name + '"]'
          )),
          (e.list = e.container.querySelector(
            '[data-dropdown-list="' + e.config.name + '"]'
          )),
          e.defaultOptionId &&
            !e.autoInitStateId &&
            (e.autoInitStateId = e.defaultOptionId);
      },
      l = function (e) {
        for (let t = 0; t < e.length; t++)
          a.style.removeClass(e[t], "highlight");
      },
      r = function (e, n) {
        let o = n.getAttribute("data-dropdown-list");
        var i, l;
        t.scrollElementAnimated('[data-dropdown-list="' + o + '"]', e, 0, 90),
          (i = e),
          (l = n),
          a.style.addClass(i, "highlight"),
          i.addEventListener("mouseout", function (e) {
            a.style.removeClass(i, "highlight");
          }),
          l.addEventListener("mouseover", function (e) {
            e.target.getAttribute("data-option-name") !==
              i.getAttribute("data-option-name") &&
              a.style.removeClass(i, "highlight");
          });
      },
      s = function (e) {
      ...
      c = function (e) {
        ["keypress", "click"].forEach(function (t) {
          ...
          e.element &&
            !e.element.getAttribute("data-listen-" + t) &&
            (e.element.addEventListener(t, function (t) {
              if (
                !t.target.closest(".dropdownListContainer") &&
                (13 === t.which || "click" === t.type)
              ) {
                e.showHide(),
                  "true" === n.getAttribute("aria-expanded")
                    ? (n.blur(), document.addEventListener("keypress", a))
                    : (l(o.children),
                      document.removeEventListener("keypress", a));
              }
            }),
            e.element.setAttribute("data-listen-" + t, !0)),
            i &&
              !i.getAttribute("data-listen-" + t) &&
              (i.addEventListener(t, function () {
                e.showHide();
              }),
              i.setAttribute("data-listen-" + t, !0)),
            o &&
              !o.getAttribute("data-listen-" + t) &&
              (o.addEventListener(t, function (t) {
                if (13 === t.which || "click" === t.type) {
                  let n = t.target;
                  n.getAttribute("data-option-name") &&
                    n.getAttribute("data-option-id") &&
                    n.getAttribute("data-option-index") &&
                    (e.state.setState(
                      !1,
                      n.getAttribute("data-option-name"),
                      n.getAttribute("data-option-id"),
                    ...
                    e.setOption(e.state.name),
                    e.delegate.didOptionSelect(e.state.name),
                    e.delegate.didFinishUpdate(!0),
                    e.showHide());
                }
              }),
    ...
    (t.dropDownItem = function (n, a, o) {
      ...
      if (
        ...
        (l.current = !1),
        (l.openClass = "open"),
        (l.state = new t.dropDownItemState()),
        (l.dependencyMap = !1),
        (l.currentListData = !1),
        (l.subscriber = {
          target: l,
        ...
        (l.autoInitStateId = void 0),
        (l.defaultOptionId = o.defaultOptionId || !1),
        l.config.dependencies && l.config.dependencies.length > 0)
      ) {
        l.dependencyMap = {};
        for (let e = 0; e < l.config.dependencies.length; e++)
          l.dependencyMap[l.config.dependencies[e]] = new t.dropDownItemState();
      }
      ...
      (t.dropDownItem.prototype.init = function () {
        !(function (e) {
          ...
          e.defaultOptionId &&
            ...
            (e.autoInitStateId = e.defaultOptionId),
            e.config.data &&
              (!e.config.dependencies || e.config.dependencies.length < 1) &&
              e.renderOptions(),
            !e.config.dataUrl ||
              (e.config.dependencies && 0 !== e.config.dependencies.length) ||
              e.config.dataDependency ||
              (e.setLoading(),
              (e.subscriber.url = e.config.dataUrl),
              a.data.manager.add(e.subscriber));
        })(this);
      }),
      (t.dropDownItem.prototype.updateOptionsFromDependencies = function (
        t,
        n
      ) {
        let o = this;
        if (
          (o.displayDefaultOption(!1, !1, !0),
          o.setInactive(),
          o.delegate && o.delegate.dropdownRendered(o.config.index),
          !o.isloading)
        ) {
          if (
            (o.dependencyMap[t] && (o.dependencyMap[t] = n),
            o.config.dependancyCheck &&
              "function" == typeof o.config.dependancyCheck)
          ) {
            if (!o.config.dependancyCheck(o.dependencyMap)) return;
          }
          if (
            o.config.dataDependency &&
            t === o.config.dataDependency &&
            n.list
          )
            return (
              -1 !== n.index
                ? (o.renderOptions(n.list[n.index]), o.setActive())
                : ((o.state.list = []),
                  o.setInactive(),
                  o.displayDefaultOption(!1, !1, !0)),
              (o.autoInitStateId && !o.defaultItem) || o.displayDefaultOption(),
              void (o.autoInitStateId = void 0)
            );
          (o.subscriber.url = (function (t) {
            ...
            for (let e = 0; e < t.config.dependencies.length; e++)
              if (n) {
                ...
                if (
                  ((a =
                    t.config.depMethods &&
                    t.config.depMethods[e].default &&
                    -1 === parseInt(t.dependencyMap[o].id)
                      ? t.config.depMethods[e].default
                      : t.dependencyMap[o].id),
                  -1 === parseInt(a))
                )
                  return (t.list.innerHTML = ""), !1;
                n = n.replace("{{" + o + "}}", a);
              }
            if (t.config.depMethods)
              for (let o = 0; o < t.config.depMethods.length; o++) {
                ...
                i.method &&
                  e.filterData[i.method] &&
                  (n = n.replace(
                    "{{" + i.label + "}}",
                    e.filterData[i.method](a)
                  ));
              }
            return n;
          })(o)),
            o.subscriber.url &&
              (o.setLoading(), a.data.manager.add(o.subscriber)),
            o.config.data && o.renderOptions(void 0, void 0, !0);
        }
      }),
      (t.dropDownItem.prototype.getAutoOptionIndex = function () {
        ...
        if (e.autoInitStateId && e.options && e.options.length > 0)
          for (let t = 0; t < e.options.length; t++)
            if (
              e.options[t].optionId === parseInt(e.autoInitStateId) ||
              e.options[t].optionId === e.autoInitStateId
            )
              return t;
        return -1;
      }),
      (t.dropDownItem.prototype.displayDefaultOption = function (e, t, n) {
        ...
        if (i > -1 && o.options[i] && t) {
          let e = o.options[i];
          o.state.setState(!1, e.optionName, e.optionId, !1, i),
            o.setOption(e.optionName);
        } else if (
          !o.config.defaultOption ||
          ("-1" !== o.autoInitStateId &&
            !n &&
            (void 0 !== o.config.defaultIndex ||
              (o.defaultOptionId &&
                -1 !== o.defaultOptionId &&
                0 !== o.state.list.length)))
        ) {
          if (o.defaultOptionId && o.defaultItem) {
            let e = !1;
            for (let t = 0; t < o.state.list.length; t++)
              a.object.getNestedItemFromPath(
                o.config.dataIdPath,
                o.state.list[t]
              ) === o.defaultItem.optionId && (e = !0);
            e
              ? o.state.setState(
                  !1,
                  o.defaultItem.optionName,
                  o.defaultItem.optionId,
                  !1,
                  o.defaultItemIndex
                )
              : o.state.setState(
          ...
          o.state.setState(!1, o.config.defaultOption, -1, !1, -1),
            o.setOption(o.config.defaultOption);
        o.hide();
      }),
      ...
      (t.dropDownItem.prototype.checkActive = function () {
        let e = this;
        -1 !== e.state.index
          ? a.style.addClass(e.element, "active")
          : a.style.removeClass(e.element, "active");
      }),
      (t.dropDownItem.prototype.restoreOptions = function (e) {
        let n = this;
        (n.initialisedOptions = !1), (n.state = e);
        let o = Object.keys(e);
        for (n.state = new t.dropDownItemState(), d = 0; d < o.length; d++)
          n.state[o[d]] = e[o[d]];
      ...
      (t.dropDownItem.prototype.renderOptions = function (e, t, o) {
        let i = this;
        !i.initialisedOptions && i.config.data && (e = i.config.data),
          o ||
            (i.state.list = a.object.getNestedItemFromPath(
              i.config.dataListPath,
              e
            )),
          i.config.listTransform &&
            "function" == typeof i.config.listTransform &&
            (i.state.list = i.config.listTransform(i.state.list, i.element, i)),
          !i.state.list && e && (i.state.list = e),
          (i.options = []);
        for (let e = 0; e < i.state.list.length; e++)
          (i.state.list[e].hasOwnProperty("gameweek") &&
            "U" === i.state.list[e].status) ||
            (i.options.push({
              optionName: a.object.getNestedItemFromPath(
                i.config.dataNamePath,
                i.state.list[e]
              ),
              optionId: a.object.getNestedItemFromPath(
                i.config.dataIdPath,
                i.state.list[e]
              ),
            ...
            i.autoInitStateId &&
              !i.initialisedOptions &&
              i.options[e].optionId === i.autoInitStateId &&
              ((i.defaultItem = i.options[e]),
              (i.defaultItemIndex = e),
              i.state.setState(
                !1,
                i.defaultItem.optionName,
                i.defaultItem.optionId,
                !1,
                e
              ),
              i.setOption(i.state.name)));
        i.config.hasOwnProperty("displayDefaultOption") ||
          i.config.displayDefaultOption ||
          i.displayDefaultOption(!1, !0),
          (i.list.innerHTML = Mustache.render(n.listfilteroption, {
            config: i.config,
          ...
          o && (i.autoInitStateId = void 0),
          i.setActive(),
          i.isloading && i.stopLoading(),
          (i.initialisedOptions = !0),
          i.delegate && i.delegate.dropdownRendered(i.config.index),
          c(i);
      }),
      (t.dropDownItem.prototype.setLoading = function () {
        ...
        (e.isloading = !0),
          e.loaderElement ||
            ((e.loaderElement = document.createElement("div")),
            e.loaderElement &&
              ((e.loaderElement.innerHTML = n.loader),
              (e.loaderElement = e.loaderElement.children[0]))),
          e.element.insertBefore(e.loaderElement, e.element.firstChild);
      }),
      (t.dropDownItem.prototype.stopLoading = function () {
        let e = this;
        (e.isloading = !1),
          e.loaderElement &&
            (e.element.removeChild(e.loaderElement),
            (e.loaderElement = void 0));
      }),
      (t.dropDownItem.prototype.setActive = function () {
        let e = this;
        e.element.classList.remove("inactive"),
          e.list.removeAttribute("aria-disabled"),
          e.current.removeAttribute("aria-disabled"),
          e.current.setAttribute("tabindex", "0");
      }),
      (t.dropDownItem.prototype.setInactive = function () {
        let e = this;
        e.element.classList.add("inactive"),
          e.list.setAttribute("aria-disabled", "true"),
          e.current.setAttribute("aria-disabled", "true"),
          e.current.setAttribute("tabindex", "-1");
      }),
      (t.dropDownItem.prototype.openDropdown = function (e) {
        let t = this;
        a.style.addClass(e, t.openClass),
          a.event.listenForOutsideClick.addElement(
            e,
            t.closeDropdown.bind(t),
            e
          );
      }),
      (t.dropDownItem.prototype.closeDropdown = function (e) {
        a.style.removeClass(e, this.openClass),
          a.event.listenForOutsideClick.removeElement(e, this.closeDropdown);
      }),
      (t.dropDownItem.prototype.showHide = function () {
        ...
        if (e.list.children.length > 0 && e.isActive()) {
          if (
            (e.list.children[0].focus(),
            a.style.hasClass(e.element, e.openClass)
              ? e.closeDropdown(e.element)
              : e.openDropdown(e.element),
            (e.state.open = e.element.classList.contains(e.openClass)),
            "true" === t[0].getAttribute("aria-expanded")
              ? t[0].setAttribute("aria-expanded", "false")
              : t[0].setAttribute("aria-expanded", "true"),
            e.state.open)
          )
            return void e.delegate.didOpen(e);
      ...
      (t.dropDownItem.prototype.hide = function () {
        let e = this;
        e.element.classList.remove(e.openClass),
          (e.state.open = !1),
          e.delegate.didClose(e);
      });
    ...
    (e.dropDownItemState = function (e, t, n, a, o) {
      ...
      (e.dropDownItemState.prototype.setState = function (e, t, n, a, o) {
        (this.open = e),
          ...
          (this.index = "number" == typeof parseInt(o) ? o : this.index);
      });
  })(PULSE.app.common),
  (function (e, t, n) {
    (n.listFilterClubSeasons = function (e, a, o) {
      ...
      let l = {
        url: n.createApiPath("clubs.single", { id: i.team }),
        method: "GET",
  ...
  (function (e, t, n, a, o) {
    ...
    (t.listFilterController = function (e, i) {
      ...
      if (
        ...
        (l.intervalChecker = !1),
        (l.dropdowns = {}),
        (l.delegate = l.config.delegate || !1),
        (l.tracking = l.config.tracking || !1),
        (l.noInit = l.config.noInit),
        (l.updateUrl =
          this.element.getAttribute("data-use-history") ||
          this.element.getAttribute("data-use-basic-history") ||
          !1),
        (l.basicHistory =
          this.element.getAttribute("data-use-basic-history") || !1),
        (l.defaultItemIds =
          l.element.getAttribute("data-filter-default-ids") || !1),
        (l.url = !1),
        (function (e, i) {
          (e.mobileHeader = n.dom.appendDomString(
            e.element,
            Mustache.render(a.mobileheader, {
              title: o.lookup("label.filters"),
              buttonText: o.lookup("label.reset"),
            })
          )),
            e.defaultItemIds &&
              (e.defaultItemIds = e.defaultItemIds.split(",")),
            (e.renderedDropdowns = []),
            (e.dropdownsRendered = !1),
            1 == i.length && n.style.addClass(e.element, "singleFilter");
          for (var l = 0; l < i.length; l++) {
            let n = i[l];
            e.defaultItemIds &&
              e.defaultItemIds[l] &&
              !n.defaultOptionId &&
              (n.defaultOptionId = e.defaultItemIds[l]),
              (n.index = l),
              (n.visibleMobile = l === i.length - 1),
              (e.dropdowns[n.name] = new t.dropDownItem(e.element, e, n));
          }
          for (l = 0; l < i.length; l++) {
            let t = i[l];
            e.dropdowns[t.name].init();
          }
          (e.advancedFilterButtons = n.dom.appendDomString(
            e.element,
            Mustache.render(a.mobilefooter, {
            ...
            e.didFinishUpdate(!0, !0);
        })(l, i.dropdowns, l.config),
        "true" === l.element.getAttribute("data-reset-available"))
      ) {
      ...
      !(function (e) {
          ...
          ((window.onpopstate = function (t) {
            if (t.state && t.state.length)
              for (let n = 0; n < t.state.length; n++)
                e.dropdowns[t.state[n].name].restoreOptions(t.state[n].state);
            e.didFinishUpdate(!1);
          }),
          e.advancedFilterButtons &&
            e.advancedFilterButtons.length > 0 &&
            ["click", "keypress"].forEach((t) => {
              e.advancedFilterButtons[0].addEventListener(t, function (n) {
                ("click" === t || ("keypress" === t && "Enter" === n.key)) &&
                  (document.body.classList.toggle("u-body-no-scroll"),
                  e.element.classList.toggle("open"));
              });
            }),
          e.advancedFilterButtons &&
            e.advancedFilterButtons.length > 1 &&
            ["click", "keypress"].forEach((t) => {
        ...
        e.mobileHeader &&
          e.mobileHeader.addEventListener("click", function (t) {
            e.element.classList.remove("open"),
              document.body.classList.remove("u-body-no-scroll");
          });
      })(l);
    }),
      (t.listFilterController.prototype = Object.create(
        t.filterDropdownDelegate.prototype
      )),
      (t.listFilterController.prototype.resetAll = function () {
        let e = this,
          t = Object.keys(e.dropdowns);
        for (let n = 0; n < t.length; n++)
          e.dropdowns[t[n]].displayDefaultOption(!0);
        e.delegate && e.delegate.filterCleared(e.getState()),
          e.updateUrl && i(e),
          e.delegate &&
            e.waitForLoadComplete(function () {
      ...
      (t.listFilterController.prototype.setPageLoading = function (t, a, i) {
        ...
        (t.loaderMarkup =
          t.loaderMarkup ||
          Mustache.render(e.templates.scrollloader, {
      ...
      (t.listFilterController.prototype.didUpdate = function (e) {
        !(function (e, t) {
          ...
          for (let a = 0; a < n.length; a++)
            e.dropdowns[n[a]].config.dependencies &&
              e.dropdowns[n[a]].config.dependencies.indexOf(t.config.name) >
                -1 &&
              e.dropdowns[n[a]].updateOptionsFromDependencies(
                t.config.name,
                t.state
              );
        })(this, e);
      ...
      (t.listFilterController.prototype.didFinishUpdate = function (e, t) {
        let n = this;
        !n.delegate || (n.noInit && t)
          ? n.updateUrl && e && !t && i(n)
          : n.waitForLoadComplete(function () {
              n.updateUrl && e && !t && i(n),
                n.delegate.filterUpdated(n.getState(), t);
            });
      }),
      (t.listFilterController.prototype.waitForLoadComplete = function (e) {
        let t = this;
        t.intervalChecker ||
          (t.intervalChecker = setInterval(function () {
            let n = !0,
              a = Object.keys(t.dropdowns);
            for (let e = 0; e < a.length; e++)
              t.dropdowns[a[e]].isloading && (n = !1);
            n &&
              (clearInterval(t.intervalChecker),
              (t.intervalChecker = null),
              e());
          }, 500));
      }),
  ...
  (function (e) {
    (e.scrollLoaderDelegate = function () {}),
      (e.scrollLoaderDelegate.prototype.didRequestLoad = function () {});
  })(PULSE.app.common),
  (function (e, t, n, a) {
    let o = function (e) {
        e.element = t.dom.appendDomString(
          e.container,
          '<div class="loader" data-scroll-loader style="min-height:10px;" ></div>'
        );
      },
      i = function (e) {
          ...
          if (!e.loading && e.element) {
            ...
            (t = e.boundary
              ? e.element.getBoundingClientRect().top -
                e.boundary.getBoundingClientRect().top
              : e.element.getBoundingClientRect().top),
              (e.boundary.clientHeight || window.innerHeight) - t >= e.limit &&
                0 !== e.element.offsetHeight &&
                ((e.loading = !0),
                r(e),
                e.delegate && e.delegate.didRequestLoad());
          }
        });
      };
    var l = function (e) {
    ...
    var r = function (e) {
      if (e.element) {
        ...
        e.element.innerHTML = Mustache.render(n.scrollloader, { load: t });
      }
    };
        ...
        (t.loading = !1),
          e
            ...
            : (function (e) {
                e.element &&
                  e.container &&
                  (e.container.appendChild(e.element), l(e));
              })(t);
      });
  ...
  (function (e, t, n, a) {
    (a.pageShare = function (a, o) {
      ...
      if (
        ((i.element = a),
        (i.render = i.element.getAttribute("data-render")),
        (i.bodyContent = i.element.getAttribute("data-body")),
        (i.defaultOpen = i.element.getAttribute("data-open")),
        (i.url = i.element.getAttribute("data-link-to")
          ? window.location.hostname + i.element.getAttribute("data-link-to")
          : o),
        i.render && e.templates[i.render])
      ) {
        let t = {
      ...
      (i.shareButton = i.element.getElementsByClassName("socialShareBtn")[0]),
        i.shareButton && (i.hoverElem = i.shareButton.parentElement),
        i.defaultOpen && t.style.toggleClass(i.hoverElem, "open"),
        i.setListeners();
    }),
      (a.pageShare.prototype.copyUrl = function (e, t, n) {
        ...
        document.body.appendChild(a),
          ...
          i.appendChild(o),
          (o.className = "option__actionlabel"),
          (o.innerHTML = "Link copied"),
          setTimeout(function () {
            i.removeChild(o);
          }, 1e3);
      }),
      (a.pageShare.prototype.getSocialDataset = function (e) {
        let t = e;
        if (this.element.getAttribute("data-social-service"))
        ...
        n.shareButton &&
          ["keypress", "click"].forEach(function (e) {
            n.shareButton.addEventListener(e, function (e) {
              (13 !== e.which && "click" !== e.type) ||
                (e.preventDefault(), t.style.toggleClass(n.hoverElem, "open"));
            });
          }),
          this.element.addEventListener("click", function (t) {
            ...
            a &&
              ...
              "copy" === a.socialService
                ? n.copyUrl(this, a.socialService, n.url)
                : e.socialHelpers[a.socialService].sharePage(
                    n.url,
                    !1,
                    n.bodyContent
                  ));
  ...
  (function (e, t) {
    (e.analytics.trackEvent = function (e) {
      if (e) {
        const n = { event: "click", contentType: "widget" };
        let a = t.object.extend(n, e);
        void 0 !== window.dataLayer
          ? dataLayer.push(a)
          : console.warn("dataLayer not found when trying to track event");
      }
    }),
      (e.analytics.addEventTracking = function () {
        let t =
          arguments.length > 0 && void 0 !== arguments[0]
            ...
            : document;
        [].slice
          .call(t.querySelectorAll(".js-tracked-event"))
          .filter((e) => "click" === e.getAttribute("data-event-type"))
          .forEach((t) => {
  ...
  (function (e) {
    (e.MediaThumbnailTracking = function (e) {
      const t = this;
      (t.collectionTitle = e.dataset.collectionTitle),
        (t.collectionFocus = e.dataset.collectionFocus),
        (t.collectionCategory = e.dataset.collectionCategory),
        (t.mediaTitle = e.dataset.title),
        (t.mediaType = e.dataset.contentType),
        (t.itemIndex = e.dataset.itemIndex),
        (t.theme = e.dataset.theme),
        (t.optaId = e.dataset.optaId),
        (t.isExternal = "true" === e.dataset.isExternal),
          ...
          n.preventDefault(),
            dataLayer.push({
              ...
              eventCallback: function () {
                e.dataset.modalActive ||
                  (t.isExternal
                    ? window.open(e.getAttribute("href"), "_blank").focus()
                    : (window.location.href = e.getAttribute("href")));
              },
            });
        });
    }),
      e.widgetInitialiser.addMultipleWidgetsByName(
        "media-thumbnail-tracking",
        e.MediaThumbnailTracking
      );
  })(PULSE.app),
  (function (e, t) {
    ...
    const n = function (t) {
      ...
      if (void 0 !== window.dataLayer) {
        let e = Object.assign({ event: t }, a, n);
        dataLayer.push(e);
      } else
        console.warn("dataLayer not found when trying to track articleView");
    };
  })(PULSE.app, PULSE.app.common),
  (function (e) {
    e.articleTable = function (e) {
      (this.tables = e.querySelectorAll("table")),
        this.tables.forEach((e) => {
          e.parentElement.classList.contains("article__body") &&
            (e.outerHTML =
              '<div class="article__table">' + e.outerHTML + "</div>");
        });
    };
    document
      .querySelectorAll(".standardArticle")
      .forEach((t) => new e.articleTable(t));
  })(PULSE.app.common),
  (function (e) {
    e.broadcasterLogo = function (t) {
      ...
      if (arguments.length > 1 && void 0 !== arguments[1] && arguments[1]) {
        if (
          ((a = t.querySelectorAll(".js-broadcaster-logo")), !a.length && n < 5)
        )
      ...
      for (let e = 0; e < a.length; e++) {
        ...
        if (t.complete) {
          if (0 === t.naturalHeight && 0 === t.naturalWidth) {
            ...
            t.srcset && t.srcset.length && (t.src = t.srcset.split(",")[0]),
    ...
    let t = document.querySelectorAll('[data-widget="broadcaster-logo-image"]');
    for (let n = 0; n < t.length; n++) new e.broadcasterLogo(t[n]);
  })(PULSE.app, PULSE.app.common),
  (function (e, t) {
    (e.checkGameweek = function (e) {
      let t = this;
      (t.config = e || {}),
        (t.compSeason = t.config.compSeason),
        (t.gameWeek = t.config.gameWeek),
        (t.callback = t.config.callback),
        (t.target = t.config.target),
        t.getCurrentWeek();
    }),
      (e.checkGameweek.prototype.getCurrentWeek = function () {
        let n = { id: this.compSeason },
          a = {
      ...
      (e.checkGameweek.prototype.checkGameweek = function (e) {
        ...
        if (e && e.gameweeks && e.gameweeks.length > 0) {
          let n = !1;
          e.gameweeks[0].gameweek == t.gameWeek && (n = !0),
            t.callback.call(t.config.target, n);
        }
      });
  })(PULSE.app.common, PULSE.core),
  (function (e, t) {
    e.clubBadge = function (n) {
      ...
      let o;
      if (arguments.length > 1 && void 0 !== arguments[1] && arguments[1]) {
        if (((o = n.querySelectorAll(".js-badge-image")), !o.length && a < 5))
          return void setTimeout(function () {
            e.clubBadge(n, !0, a + 1);
          }, 500);
      ...
      for (let i = 0; i < o.length; i++) {
        ...
        if (l.complete) {
          if (0 === l.naturalHeight && 0 === l.naturalWidth) {
            ...
            if (!t.getDefaultBadge && a < 5)
              return void setTimeout(function () {
                e.clubBadge(n);
              }, 500);
            let i = t.getDefaultBadge(o);
            l.srcset && l.srcset.length
              ? (l.src = l.srcset.split(",")[0])
              : (l.src = i),
          ...
          l.onerror = function () {
            ...
            this.srcset && this.srcset.length
              ? (this.src = this.srcset.split(",")[0])
              : (this.src = n),
              this.removeAttribute("srcset");
          };
      ...
      (e.reoderBroadcasters = function (e, t) {
        return (
          "US" !== t ||
            e.forEach((t) => {
              if (
                "UNIVERSO" === t.abbreviation ||
                "TELEMUND" === t.abbreviation
              ) {
                const n = e.indexOf(t);
  ...
  (function (e, t, n, a) {
    ...
    t.getContentModel = function (n) {
      ...
      switch (((i.template = i.type), i.type)) {
        case "text":
          (i.articleUrl = i.hotlinkUrl
            ? i.hotlinkUrl
            : i.url
            ? i.url
            : t.generateContentUrl(i.type, i.id)),
            null != i.tags &&
              ...
              if (e.tags && e.tags.length > 0)
                for (let t = 0; t < e.tags.length; t++)
                  if (
                    e.tags[t] &&
                    e.tags[t].label &&
                    e.tags[t].label.indexOf("OptaID") > -1
                  ) {
                    let n = e.tags[t].label.split("_");
                    if (n.length > 1) return n[1];
                  }
            })(i)),
            i.leadMedia && i.leadMedia.variants && "video" != i.leadMedia.type)
          ) {
            var r = e["Embed Photo"];
            (i.variant = t.getVariantBySize(
              i.leadMedia.variants,
              r.width,
              r.height
            )),
              (i.imageAlt = i.leadMedia.title);
          } else
            i.leadMedia && i.leadMedia.thumbnailUrl
              ? ((i.variant = { url: i.leadMedia.thumbnailUrl }),
                (i.imageAlt = i.leadMedia.title))
              : i.optaId &&
                (i.variant = { url: t.getDefaultTeamThumbnailUrl(i.optaId) });
          if (i.related) {
            let e = [];
            i.related.forEach(function (n, a) {
              a < 3 &&
                ((n.url = t.generateContentUrl(n.type.toLowerCase(), n.id)),
                e.push(n));
            }),
              (i.related = e);
          }
        ...
        case "photo":
          ...
          (i.svgPath =
            "M39.8,65.2H13.5c-1.2,0-2.2-1-2.2-2.2V36.7c0-0.9,0.5-1.7,1.4-2.1c0.8-0.4,1.8-0.2,2.4,0.4l8.4,8c0.9,0.9,0.9,2.3,0.1,3.2"),
            (i.svgPath +=
        ...
        case "video":
          if (
            ((l =
              void 0 !== i.publishFrom
                ? i.publishFrom
                : void 0 !== i.timestamp
                ? i.timestamp
                : i.date),
            i.thumbnail && i.thumbnail.variants.length > 0)
          ) {
            r = e["Embed Photo"];
            (i.variant = t.getVariantBySize(
              i.thumbnail.variants,
              r.width,
              r.height
            )),
              void 0 === i.variant && (i.variant = { url: i.thumbnailUrl });
          } else i.variant = { url: i.thumbnailUrl };
          i.tags &&
            null !== i.tags &&
            !Array.isArray(i.tags) &&
            i.tags.map(function (e) {
              "fantasy" === e.label.toLowerCase() &&
                (i.fantasy = "thumbnail--fantasy");
            }),
            (i.uiArgs = JSON.stringify({
              ...
              mediaHotlinkText:
                i.metadata && i.metadata.hotlinkText
                  ? o(i.metadata.hotlinkText)
                  : "",
            })),
            ...
            i.closedCaptioned && (i.ccString = a.lookup("label.closedcaption")),
            (function (e) {
              let t = null;
              return (
                e.references &&
          ...
          break;
        case "playlist":
          "PHOTO" === i.typeRestriction
            ? (i.url = t.generateContentUrl("gallery", i.id))
            : (i.url = t.generateContentUrl(type, i.id)),
            i.coverItem &&
              i.coverItem.variants &&
              (i.variant = t.getVariantBySize(
                i.coverItem.variants,
                e["Embed Photo"].width,
                e["Embed Photo"].height
              )),
            (i.itemsSize = i.items ? i.items.length : 0);
      }
      return i;
    };
  ...
  (function (e, t) {
    (e.getPlayerModel = function (n) {
      let a = n;
      return (
        (a.url = e.generateContentUrl(
          "player",
          a.id,
          a.name.display.replace(new RegExp(" ", "g"), "-")
        )),
        (a.imageSize = "110x140"),
        (a.playerImage = a?.altIds?.opta
          ? e.getPlayerImg(a.altIds.opta, a.imageSize)
          : e.getDefaultPlayerImg(a.imageSize)),
        (a.optaId = a?.altIds?.opta ? a.altIds.opta : void 0),
        (a.activeClass = a.active ? "active" : "inactive"),
        (a.names = e.splitDisplayName(a.name.display)),
        a.info && a.info.shirtNum && (a.shirtNum = a.info.shirtNum),
        a.latestPosition &&
          (a.positionLabel = t.lookup(
        ...
        a.nationalTeam
          ...
          : a?.birth?.country?.country &&
            a?.birth?.country?.isoCode &&
            (a.nationality = {
        ...
        !a.latestPosition ||
          ("GOALKEEPER" !== a.latestPosition &&
            "DEFENDER" !== a.latestPosition) ||
          a.stats.push({
        ...
        a.currentTeam &&
          ((a.team = {
            ...
            url: e.generateContentUrl(
              "team",
              a.currentTeam.club.id,
              a.currentTeam.club.name.replace(new RegExp(" ", "g"), "-")
            ),
          }),
          (a.team.opta =
            a.currentTeam.altIds && a.currentTeam.altIds.opta
              ? a.currentTeam.altIds.opta
              : "")),
        a?.team?.opta &&
          ((a.clubBadge = e.getClubBadge(a.team.opta, "25")),
          (a.clubBadgeRetina = e.getClubBadge(a.team.opta, "25", !0)),
          (a.clubBadgeSmall = e.getClubBadge(a.team.opta, "20")),
          (a.clubBadgeSmallRetina = e.getClubBadge(a.team.opta, "20", !0)),
          (a.clubBadgeMedium = e.getClubBadge(a.team.opta, "50")),
          (a.clubBadgeMeidumRetina = e.getClubBadge(a.team.opta, "50", !0)),
          (a.clubBadgeLarge = e.getClubBadge(a.team.opta, "100")),
          (a.clubBadgeLargeRetina = e.getClubBadge(a.team.opta, "100", !0))),
        (a.profileLabel = t.lookup("label.profile")),
        a
      );
    }),
      (e.getManagerModel = function (n) {
        ...
        return (
          ...
          (a.imageSize = "110x140"),
          (a.playerImage = e.getDefaultPlayerImg(a.imageSize)),
          (a.optaId = a.altIds && a.altIds.opta ? a.altIds.opta : void 0),
          (a.activeClass = a.active ? "active" : "inactive"),
          a.nationalTeam
            ? (a.nationality = {
                country: a.nationalTeam.country,
          ...
          a?.team?.opta &&
            ((a.clubBadge = e.getClubBadge(a.team.opta, "25")),
            (a.clubBadgeRetina = e.getClubBadge(a.team.opta, "25", !0))),
          (a.profileLabel = t.lookup("label.managerProfile")),
          a
        );
      }),
      ...
      (e.splitDisplayName = (e) => {
        ...
        return (
          t.length < 2
            ? ((n.first = ""), (n.last = t[0]))
            : ((n.first = t[0]), (n.last = t.slice(1, t?.length).join(" "))),
          n
        );
      }),
      (e.isFastMovingDataEnabled = () =>
        "true" ===
        ("undefined" != typeof FAST_MOVING_DATA_ENABLED
          ? FAST_MOVING_DATA_ENABLED
          : "false"
        )
          .trim()
          .toLowerCase());
    ...
    (e.momentGetDaysFromRange = function (e, a, o, i) {
      ...
      i &&
        ...
        c.push({
          date: l,
          string:
            n && o ? n(l).locale(t.language).format(o) : l.toLocaleDateString(),
      ...
      do {
        ...
        c.push({
          date: e,
          string:
            n && o ? n(e).locale(t.language).format(o) : e.toLocaleDateString(),
        ...
        if (e) {
          ...
          return a <= 0
            ? t
              ...
              : "just now"
            : a < 60
            ? Math.round(a) + (t ? t.seconds : "s")
            : a < 3600
            ? Math.round(a / 60) + (t ? t.minutes : "m")
            : a < 86400
            ? Math.round(a / 3600) + (t ? t.hours : "h")
            : Math.round(a / 86400) + (t ? t.days : "d");
        }
      });
  ...
  (function (e, t, n) {
    (t.getDefaultPlayerImg = function (e) {
      ...
      (t.setPlayerImageLoader = function (e, n, a, o) {
        let i,
          l = t.getPlayerImg(e, n, o),
          r = t.getDefaultPlayerImg(n);
        (a.onerror = function () {
          a.getAttribute("data-error") ||
            (a.setAttribute("data-error", !0),
            (i = document.querySelectorAll('[data-player="' + e + '"]')),
            i.forEach((e) => {
      ...
      (t.getImageUrl = function () {
        let e =
          ...
          a =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "";
        if (e) {
          if (e.onDemandUrl && (n || a))
            return e.onDemandUrl + "?width=" + n + "&height=" + a;
      ...
      (t.getClubBadge = function (t, n, a, o, i) {
        let l = a ? "@x2" : "",
          r = o;
        const s = [],
          c = ["t14"];
        if ([].includes(t) || s.includes(t))
          return (
            (r = "svg"),
            s.includes(t) && (r = "png"),
            e.environment.badges + "rb/" + t + "." + (r || "png")
          );
        {
          let a = "";
          return (
            i && c.includes(t) && (a = "-hover"),
            e.environment.badges +
              (n || "medium") +
              "/" +
              t +
              a +
      ...
      (t.getPhotosForContainer = function (e) {
        if (e) {
          ...
          for (; o > -1; ) {
            ...
            t.setPlayerImageLoader(e, i, a[o], l),
              n.style.removeClass(a[o], "js-player-photo-container"),
              o--;
          }
        }
      }),
      (t.hideSponsorLogo = (e) =>
        ("undefined" != typeof SPONSOR_LOGOS_TO_HIDE
          ? SPONSOR_LOGOS_TO_HIDE
          : ""
        )
          .trim()
          .toLowerCase()
        ...
        if (t && n && a) {
          ...
          for (i = 0; i < u.length; i++)
            if (d && d[u[i]]) {
              ...
              if (t && t.length > 0)
                for (let e = 0; e < d[u[i]].length; e++)
                  t[0].appendChild(d[u[i]][e]);
            }
        }
      });
  })(PULSE.app, PULSE.app.common, PULSE.core),
    ...
    (e.getEventTypeClass = function (e, t) {
      ...
      (e.getEventLabel = function (e) {
        switch (e.type) {
          case "PS":
            return "1" === e.phase
              ? t.lookup("label.kickoff")
              : t.lookup("label.secondhalf");
          case "PE":
            return "1" === e.phase
              ? t.lookup("label.halftime")
              : t.lookup("label.fulltime");
        }
        switch (e.description) {
          case "G":
          case "P":
      ...
      (e.getPlayerForType = function (n, a, o, i) {
        ...
        return (
          ...
          "Y" != a.description &&
            ("P" === a.description
              ? (r += " (" + t.lookup("label.penalty.short") + ")")
              : "O" === a.description &&
                (r += " (" + t.lookup("label.owngoal.short") + ")"),
            n[o][i] || (n[o][i] = []),
            n[o][i].push({ label: r, val: l })),
          n
        );
      }),
      (e.getPlayerEvents = function (t, n) {
        const a = { goalAndAssist: {}, playerBookings: {} },
          o = { goalAndAssist: {}, playerBookings: {} };
        return (
          t &&
            t.length > 0 &&
            t.forEach((t) => {
              ...
              if (
                ...
                i.goalAndAssist[`${t.personId}`]
                  ? i.goalAndAssist[`${t.personId}`].matchEvents.push({
                      scorerId: t.personId,
                      time: e.getEventTime(t),
                      isPenalty: "P" == t.description,
                      scorerName: l?.name.display || "",
                      scorerFirstName: e.splitDisplayName(l?.name.display)
                        .first,
                      ...
                      matchEvents: [
                        {
                          ...
                          scorerFirstName: e.splitDisplayName(l?.name.display)
                            .first,
                          scorerLastName: e.splitDisplayName(l?.name.display)
                            .last,
                          assistName: r?.name.display || "",
                          description: t.description || "",
                          assistId: t.assistId || "",
                  ...
                  matchEvents: [
                    {
                      ...
                      scorerFirstName: e.splitDisplayName(s?.name.display)
                        .first,
              ...
              if (
                ...
                if (
                  ...
                  a &&
                    a[t.personId] &&
                    a[t.personId][c] &&
                    a[t.personId][c].length > 0 &&
                    a[t.personId][c][0].val == t.clock.secs &&
                    ("Y" !== c || !a[t.personId].YR))
                ) {
                  var i = 0;
                  if (
                    (n[1].teamId === t.teamId && (i = 1),
                    (r = e.getPlayerForEvent(n, t.personId)))
                  ) {
                    "G" === c && a[t.personId][c].length > 1
                      ? (s = "icn ball-2-sm-w")
                      : "G" === c && (s = "icn ball-white");
                    var l =
                      " " +
                      a[t.personId][c]
                        .map(function (e) {
                    ...
                    o.matchEvents[i].push({
                      ...
                      playerUrl: e.generateContentUrl(
                        "player",
                        r.id,
                        r.name.display.replace(new RegExp(" ", "g"), "-")
                      ),
                      eventTimes: l,
                    });
                  }
                ...
                if (
                  ...
                  a[t.assistId] &&
                  a[t.assistId].AS &&
                  a[t.assistId].AS.length > 0 &&
                  a[t.assistId].AS[0].val == t.clock.secs
                ) {
                  var r;
                  i = 0;
                  if (
                    ...
                    l =
                      " " +
                      a[t.assistId].AS.map(function (e) {
                        return e.label;
                      }).join(",") +
                      " ";
                    o.assists[i].push({
  ...
  (function (e, t) {
    (t.ModalsController = function () {
      ...
      (t.ModalsController.prototype.addModal = function (e) {
        let t = this;
        -1 === t.modals.indexOf(e.config.modalContentId) &&
          (t.modals.push(e.config.modalContentId), t.instances.push(e));
      }),
      ...
      Array.prototype.map.call(n, function (e) {
        if (!e.getAttribute("data-script-created")) {
          ...
          if (
            ...
            n.setAttribute("data-script-created", !0),
  ...
  (PULSE.app.common.getTableRowClass = function (e) {
    ...
    if (e.annotations && e.annotations.length > 0)
      for (let t = 0; t < e.annotations.length; t++) {
        ...
        if (n.type && "Q" === n.type)
          return n.destination && "EU_EL" === n.destination
            ? "tableLight"
            : "tableMid";
  ...
  (function (e, t, n) {
    ...
    (t.createApiPath = function (t, a) {
      ...
      (t.createContentPath = function (t, n, o, i, l) {
        let r =
          (l ? e.environment.playerAppApi : e.environment.api) +
          "/content/" +
          (l ? "plplayerapp" : e.account) +
          "/" +
          t +
          "/" +
          (o || e.defaultLanguage) +
      ...
      (t.createLiveBlogPath = function (t, n, o, i) {
        let l =
          ...
          (t || e.defaultLanguage);
        if (
          (void 0 === i || isNaN(i) || null === i || (l += "/below/" + i), o)
        ) {
          let e = a(o);
          e.length > 0 && (l += "?" + e.join("&"));
        }
  ...
  (function (e, t) {
    const n = { root: null, rootMargin: "0px", threshold: 0.025 };
    (e.LazyLoad = function (e) {
      ...
      (e.LazyLoad.prototype.getUnobservedElements = function (e) {
        return e.filter(
          (e) => e && "true" !== e.getAttribute("data-picture-in-view")
        );
      }),
      (e.LazyLoad.prototype.setObservableListener = function (e) {
        const t = this;
        (t.observer = new IntersectionObserver(a, n)),
          e.forEach((e) => {
    ...
    const a = (e) => {
      ...
      i = function (e) {
        for (let t = 0; t < e.childNodes.length; t++)
          if (e.childNodes[t].nodeType === Node.COMMENT_NODE)
  ...
  (function (e, t) {
    ...
    e.PlayerCardImage = function (e) {
      ...
      if (
        ((o.container = e),
        (o.playerId = e.dataset.player),
        null === o.playerId)
      )
        return;
      (o.placeholder = e.querySelector(".js-lazy-load")),
        o.placeholder.classList.add(n);
      ...
      return (
        (a.onerror = function () {
          this.classList.add("player-card__player-image--error"),
            t.placeholder.classList.remove(n);
        }),
  ...
  (function (e) {
    ...
    e.validateConfig = function (e) {
      ...
      return (
        ...
        !(t.length > 0) ||
          (t.unshift(`You have ${t.length} errors initialising ${e}.`),
          console.warn(t.join("\n")),
          !1)
      );
    };
    const n = (e, n) =>
        !!n[e.namespace] ||
        (t.push(
          `Missing configuration property. config.${e.namespace} is required and should be of type ${e.elementType}`
        ),
        !1),
      a = (e, n) => {
        ...
        "object" == typeof a
          ? void 0 === a.length ||
            0 !== a.length ||
            t.push(`Empty ${e.elementType.name} under config.${e.namespace}`)
          : t.push(
              `Could not find ${e.elementType.name} under config.${e.namespace}`
            );
      },
      o = (e, n) => {
        void 0 !== e &&
          (e instanceof n.elementType ||
            t.push(
              `Incorrect type. Expected config.${n.namespace} to be instance of ${n.elementType.name}`
            ));
      };
  })(PULSE.app.common),
  (function (e) {
    ...
    e.ViewportGlue = function (e) {
      const t = this;
      (t.container = e),
        (t.items = [].slice.call(e.querySelectorAll(".js-will-glue"))),
        (t.heights = []),
        (t.observer = o.call(t, t.items));
    };
    const o = function (e) {
        const t = {
            root: null,
      ...
      i = function (e, n) {
        const i = this,
          c = e.reduce(
            (e, n) => (
              n.boundingClientRect.top <= i.heights.reduce(s, 0) &&
                !n.target.classList.contains(t) &&
                !n.target.classList.contains(a) &&
                e.exiting.push(n),
              n.boundingClientRect.top > 0 &&
                n.target.classList.contains(a) &&
                n.isIntersecting &&
                e.entering.push(n),
              e
        ...
        n.disconnect(),
          c.exiting.forEach((e) => {
            l.call(i, e.target, i.heights.reduce(s, 0)),
              i.heights.push(e.boundingClientRect.height);
          }),
          c.entering.forEach((e) => {
            r(e.target),
              i.heights.splice(
                i.heights.indexOf(e.boundingClientRect.height),
                1
              );
          });
      ...
      l = function (e) {
        ...
        i.classList.add(a),
          i.setAttribute(
            "style",
            `clear:both; height: ${e.clientHeight}px; width: 100%;`
          ),
          e.classList.add(t, n),
          e.setAttribute("style", `top: ${o}px;`);
  ...
  (function (e, t) {
    (e.ContentTracker = function (n) {
      ...
      let o = (function () {
        ...
        return (
          a.event.contentType ||
            (e += "The html element must include a 'data-tracker-type'/n"),
          a.event.contentId ||
            (e += "The html element must include a 'data-tracker-id'/n"),
          a.event.action ||
            (e += "The html element must include a 'data-tracker-action'/n"),
          e
        );
      })();
    ...
    (t.filterOptions = function (e, t) {
      ...
      (t.filterOptions.prototype.addRefsToFilters = function () {
        ...
        if ("string" == typeof e.references) t += e.references;
          ...
          for (let n in e.references)
            e.references.hasOwnProperty(n) &&
              (t.length > 0 && (t += ","), (t += n + ":" + e.references[n]));
      ...
      (t.filterOptions.prototype.updateReferences = function (t) {
        const n = this;
        void 0 !== t &&
          (n.references && "string" != typeof n.references
            ? (n.references = e.object.extend(n.references, t))
            : (n.references = t),
          n.addRefsToFilters());
      }),
  ...
  (function (e) {
    (e.StreamAMGController = function () {
      ...
      (n.endpoint = e.environment.streamAmg.script(a.partner, t || a.uiConfig)),
        (n.ready = !1),
        (n.players = []),
        (n.readyTargets = []),
        n.createAPIScript();
      ...
      (e.StreamAMGController.prototype.apiLoaded = function () {
        (this.ready = !0),
          this.readyTargets.forEach(function (e) {
            e();
          });
      }),
  ...
  (function (e, t, n) {
    ...
    (n.setCookies = (e) => {
      const n = document.location.hostname,
        ...
        i = (e) => {
          t.localStorage.setStorage("only-essential-cookies", e),
            t.localStorage.setStorage("cookie-policy-chosen", !0, 730, !0, n);
        };
      if ("true" === o) {
        i(!1);
        const e = new CustomEvent("cookiesAccepted", { detail: "all" });
        window.dispatchEvent(e);
      } else if ("false" === o) {
        i(!0);
        const e = new CustomEvent("cookiesAccepted", { detail: "essential" });
        window.dispatchEvent(e);
      }
  ...
  (function (e, t) {
    (e.CookieToggle = function (e) {
      const t = this;
      (t.acceptBtn = e.querySelector(".js-accept-btn")),
        (t.declineBtn = e.querySelector(".js-refuse-btn")),
        (t.cookieName = e.dataset.cookieName),
        (t.exclusionCookieName = `${t.cookieName}_exclusion`),
        t.renderButton(),
        t.listeners();
    }),
      (e.CookieToggle.prototype.renderButton = function () {
        const e = this,
          n = "u-hide";
        t.localStorage.getStorage(e.exclusionCookieName, !0)
          ? (t.style.removeClass(e.acceptBtn, n),
            t.style.addClass(e.declineBtn, n))
          : (t.style.addClass(e.acceptBtn, n),
            t.style.removeClass(e.declineBtn, n));
      }),
      (e.CookieToggle.prototype.listeners = function () {
        const n = this;
        n.declineBtn.addEventListener("click", () => {
          t.localStorage.setStorage(
            n.exclusionCookieName,
            !0,
            730,
            !0,
            e.environment.domain
          );
          let a = new CustomEvent("cookieDeclined", { detail: n.cookieName });
          ...
          n.acceptBtn.addEventListener("click", () => {
            ...
            let a = new CustomEvent("cookieAdded", { detail: n.cookieName });
            window.dispatchEvent(a), n.renderButton();
          });
      }),
      e.widgetInitialiser.addMultipleWidgetsByName(
  ...
  (function (e, t, n, a) {
    ...
    (t.dataCaptureHelpers.getFormObject = function (e, n, a, o, i, l) {
      ...
      let s = { formElements: [...u.map((e) => ({ ...e }))] };
      const c = s.formElements.map((e) => e.questionId).indexOf("country");
      "false" === e.displayCountry
        ? c >= 0 && s.formElements.splice(c, 1)
        : "true" === e.countryMandatory && (s.formElements[c].mandatory = !0),
        "true" === e.displayUSAFirst
          ? (s.formElements[c].displayUSAFirst = !0)
          : (s.formElements[c].displayUSAFirst = !1);
      const f = s.formElements.map((e) => e.questionId).indexOf("postcode");
      "false" === e.displayPostcode || "false" === e.displayCountry
        ? f >= 0 && s.formElements.splice(f, 1)
        : "true" === e.postcodeMandatory && (s.formElements[f].mandatory = !0);
      const h = s.formElements.map((e) => e.questionId).indexOf("dateOfBirth");
      "false" === e.displayDateOfBirth
        ? h >= 0 && s.formElements.splice(h, 1)
        : "true" === e.dateOfBirthMandatory &&
          (s.formElements[h].mandatory = !0);
      const y = s.formElements.map((e) => e.questionId).indexOf("lastName");
      "false" === e.displayLastName
        ? y >= 0 && s.formElements.splice(y, 1)
        : "true" === e.lastNameMandatory && (s.formElements[y].mandatory = !0);
      const b = s.formElements.map((e) => e.questionId).indexOf("phoneNumber");
      "false" === e.displayPhoneNumber
        ? b >= 0 && s.formElements.splice(b, 1)
        : "true" === e.phoneNumberMandatory &&
          (s.formElements[b].mandatory = !0);
      const v = s.formElements.map((e) => e.questionId).indexOf("gender");
      "false" === e.displayGender
        ? v >= 0 && s.formElements.splice(v, 1)
        : "true" === e.genderMandatory && (s.formElements[v].mandatory = !0);
      const C = s.formElements
        .map((e) => e.containerType)
        .indexOf("customTextField");
      if (a)
        for (let e = a; e > 0; e--) {
          const t = structuredClone(p);
          (t.questionId = `${t.questionId}_optional_${e}`),
            (t.title = `${t.title}_optional_${e}`),
            (t.mandatory = !1),
            s.formElements.splice(C, 0, t);
        }
      if (n)
        for (let e = n; e > 0; e--) {
          const t = structuredClone(p);
          (t.questionId = `${t.questionId}_${e}`),
            (t.title = `${t.title}_${e}`),
            s.formElements.splice(C, 0, t);
        }
      const S = s.formElements
        .map((e) => e.containerType)
        .indexOf("customCheckboxField");
      if (i)
        for (let e = i; e > 0; e--) {
      ...
      const E = s.formElements
        .map((e) => e.containerType)
        .indexOf("customDropdownField");
      if (l)
        for (let t = l; t > 0; t--) {
          const n = structuredClone(g);
          (n.questionId = `${n.questionId}_${t}`),
            (n.title = `${n.title}_${t}`),
            (n.additionalProperties = {
              dropdownOptions: e[`additionalDropdownOptions${d[t]}`],
            }),
            s.formElements.splice(E, 0, n);
        }
      const L = s.formElements.map((e) => e.questionId).indexOf("ageConsent");
      "false" === e.displayMinAge && L >= 0 && s.formElements.splice(L, 1);
      const I = s.formElements.map((e) => e.questionId).indexOf("terms");
      return (
        "false" === e.displayTermsCheckbox &&
          I >= 0 &&
          s.formElements.splice(I, 1),
        (s = t.dataCaptureHelpers.renderDataCaptureTypeSpecificFields(s, r)),
        s
      );
    }),
      (t.dataCaptureHelpers.setFormListeners = function (e, n) {
        ...
        a &&
          a.addEventListener("change", () => {
            ...
            e === s || e === c
              ? e === s
                ? (d.classList.remove("u-hide"),
                  u.dataset.required && (u.required = !0),
                  (m.required = !1),
                  p.classList.add("u-hide"),
                  g && (g.classList.add("u-hide"), (f.required = !1)))
                : e === c &&
                  (p.classList.remove("u-hide"),
                  m.dataset.required && (m.required = !0),
                  (u.required = !1),
                  d.classList.add("u-hide"),
                  g && (g.classList.add("u-hide"), (f.required = !1)))
              : e === o || e === i || e === l || e === r
              ? (d.classList.add("u-hide"),
                (u.required = !1),
                ...
                (m.required = !1),
                g &&
                  (g.classList.remove("u-hide"),
                  f.dataset.required && (f.required = !0)))
              : (d.classList.add("u-hide"),
                (u.required = !1),
                p.classList.add("u-hide"),
                (m.required = !1),
      ...
      (t.dataCaptureHelpers.getFormDataModel = function (t, n, a, o, i) {
        ...
        let r = { campaignId: n, answer: l || null },
          s = [],
          c = [],
          d = [];
        ...
        if (e.userData.signedIn) {
          ...
          for (const e of t.entries()) {
            ...
            if (("on" === n && (n = !0), t.includes("guest") && n.length)) {
              ...
              if (t.includes("guestDateOfBirth")) {
                (a = t.includes("day") ? `${n}` : `${n}-${a}`),
                  t.includes("year") && (f[e].guestDateOfBirth = a);
                continue;
              }
              f[e] ? (f[e][o] = n) : f.push({ [o]: n });
            }
            t.includes("custom") && (h[t] = n),
              "clubAccessCode" === t && (r.clubAccessCode = n),
              "numberOfGuestsUnder18" === t && (r.numberOfGuestsUnder18 = n);
          }
          if (
            ((s = [...e.userData.pl_communications]),
            (c = [...e.userData.club_communications]),
            (d = [...e.userData.followed_clubs]),
            u.forEach((e) => {
              const t = !0 === e.checked,
                n = e.value,
                a = s.findIndex((e) => e.plmarketing === parseInt(n));
              t && -1 === a
                ? s.push({ plmarketing: parseInt(n) })
                : !t && a > -1 && s.splice(a, 1);
            }),
            m && "-1" !== m.value)
          ) {
            const e = m.value.replace("t", "");
            d.push({ club: parseInt(e), is_favourite: !0 });
          }
          p.forEach((e) => {
            const t = !0 === e.checked,
              n = e.value,
            ...
            if (t) {
              if (-1 === a)
                ...
                c.find(
                  (e) => e.club === parseInt(n.replace("t", ""))
                ).club_communications = !0;
              }
              d.find((e) => e.club === parseInt(n.replace("t", ""))) ||
                d.push({
                  club: parseInt(n.replace("t", "")),
                  is_favourite: !1,
                });
          ...
          for (const n of t.entries()) {
            ...
            if (
              ("ageConsent" === t && (a = !0),
              "region" === t && (a = parseInt(a)),
              t.includes("optin_PL"))
            )
              s.push({ plmarketing: a });
            else if (("on" === a && (a = !0), t.includes("optin_club")))
              c.push({ club: a.replace("t", ""), club_communications: !0 });
            else if ("favouriteclub" !== t) {
              if (t.includes("guest") && a.length) {
                const n = parseInt(t.split("_")[1]) - 1,
                  o = t.split("_")[0];
                if (t.includes("guestDateOfBirth")) {
                  (e = t.includes("day") ? `${a}` : `${a}-${e}`),
                    t.includes("year") && (f[n].guestDateOfBirth = e);
                  continue;
                }
                f[n] ? (f[n][o] = a) : f.push({ [o]: a });
              }
              if (t.includes("dateOfBirth"))
                a.length < 2 && (a = `0${a}`),
                  (g = t.includes("day") ? `${a}` : `${a}-${g}`),
                  t.includes("year") && (r.date_of_birth = g);
        ...
        return (
          (r.source = "web"),
          (r.terms = !0),
          f.length && (r.guestFields = f),
          (r.customFields = h),
          (r.pl_communications = s),
          (r.club_communications = c),
          (r.followed_clubs = d),
          (r.dataCaptureType = a),
          r
        );
      ...
      (t.dataCaptureHelpers.renderForm = function (n, o) {
        ...
        n.formObject.formElements.forEach((l) => {
          if (!i || (i && l.signedIn)) {
            ...
            l.campaignSpecificTitle &&
              (i = a.lookup(`label.dataCapture.${n.campaignId}.${l.title}`));
            let r = [];
            "dropdown" === l.elementType &&
              (r = l?.additionalProperties?.dropdownOptions.split(",") || []);
            const s = {
              ...l,
              title: i,
              ...
              validationMessage: a.lookup(
                `label.dataCapture.${l.title}.validationMsg`
              ),
              dropdownOptions: r,
              renderSVG: () => (e) => t.icon.renderSVG(e, "error-message__svg"),
            };
            e.templates[`formelement${s.type}`] &&
              (o.innerHTML += Mustache.render(
                e.templates[`formelement${s.type}`],
                s
              ));
          }
      ...
      (t.dataCaptureHelpers.setModalPolicyText = function (e, t) {
        ...
        const r = e.querySelector(".js-policy-text"),
          s = e.querySelector(".js-update-prefs-text"),
          c = e.querySelector(".js-withdraw-club-consent");
        let d = a.lookup(`label.dataCapture.privacyPolicy.${t}`);
        if (
          (d === `label.dataCapture.privacyPolicy.${t}` &&
            (d = a.lookup("label.dataCapture.privacyPolicy")),
          (r.innerHTML = `<p>${d}</p>`),
          l.includes("52") &&
            (r.innerHTML += `<p>${a.lookup(
              "label.dataCapture.privacyPolicy.guinness"
            )}</p>`),
          n && o)
        ) {
          let e = a.lookup(`label.dataCapture.emailPrefsPolicy.${t}`);
          e === `label.dataCapture.emailPrefsPolicy.${t}` &&
            (e = a.lookup("label.dataCapture.emailPrefsPolicy"));
        } else s.innerHTML = "";
        if (i) {
          let e = a.lookup(`label.dataCapture.withdrawClubPolicy.${t}`);
          e === `label.dataCapture.withdrawClubPolicy.${t}` &&
            (e = a.lookup("label.dataCapture.withdrawClubPolicy")),
            (c.innerHTML = `<p>${e}</p>`);
        } else c.innerHTML = "";
      }),
      ...
      (t.dataCaptureHelpers.renderDataCaptureTypeSpecificFields = function (
        e,
        t
      ) {
        const n = e.formElements
          .map((e) => e.containerType)
          .indexOf("dataCaptureTypeSpecificFields");
        return (
          ("pl_mornings_live_guests" !== t && "pl_mornings_live_clubs" !== t) ||
            (f.forEach((t) => {
              if ("guestsContainer" !== t.containerType)
                e.formElements.splice(n, 0, t);
              else
                for (let t = 4; t > 0; t--) {
                  structuredClone(y).forEach((a) => {
                    (a.questionId = `${a.questionId}_${t}`),
                      (a.title = `${a.title}_${t}`),
                      (a.mandatory = !1),
                      e.formElements.splice(n, 0, a);
                  });
                }
            }),
            "pl_mornings_live_clubs" === t && e.formElements.splice(n, 0, h)),
          e
        );
      }),
      (t.dataCaptureHelpers.setDataCaptureTypeSpecificListeners = function (
        e,
        t
      ) {
        if ("pl_mornings_live_guests" === t || "pl_mornings_live_clubs" === t) {
          ...
          t.addEventListener("change", () => {
            ...
            for (let e = 0; e < n.length; e++)
              n[e].classList.add("u-hide"),
                a[e].classList.add("u-hide"),
                o[e].classList.add("u-hide"),
                (n[e].querySelector("input").required = !1),
                n[e].querySelector(".optional").classList.add("u-hide"),
                (a[e].querySelector("input").required = !1),
                a[e].querySelector(".optional").classList.add("u-hide"),
                o[e].querySelector(".optional").classList.add("u-hide"),
                o[e].querySelectorAll("input").forEach((e) => {
                  e.required = !1;
                });
            for (let t = 0; t < e; t++)
              n[t].classList.remove("u-hide"),
                a[t].classList.remove("u-hide"),
                o[t].classList.remove("u-hide"),
                (n[t].querySelector("input").required = !0),
                (a[t].querySelector("input").required = !0),
                o[t].querySelectorAll("input").forEach((e) => {
                  e.required = !0;
                });
          });
        }
      ...
      (t.dataCaptureHelpers.guestFormFieldsValid = function (e, t) {
        ...
        if ("pl_mornings_live_guests" === t || "pl_mornings_live_clubs" === t) {
          e.querySelectorAll(".js-guest-dob").forEach((e) => {
            ...
            return (
              (c < 0 || (0 === c && r.getDate() < a.getDate())) && s--,
              s >= 18 ? ((n = !1), e.classList.add("invalid"), n) : n
            );
          });
        }
        return n;
  ...
  (function (e, t) {
    let n = function (e) {
        ...
        t.style.toggleClass(n.element, "open"),
          "true" === o.getAttribute("aria-expanded")
            ? o.setAttribute("aria-expanded", "false")
            : o.setAttribute("aria-expanded", "true"),
          ((e.target && "LI" === e.target.nodeName) ||
            e.target.classList.contains("js-reset-button")) &&
            (a &&
              n.updateCurrent &&
              (a.innerHTML = e.target.getAttribute("data-label")),
            n.target &&
              n.callback &&
              n.callback.call(n.config.target, e.target));
      },
      a = function (e) {
        let n = this,
        ...
        e.target == a[0] ||
          e.target == n.element ||
          t.dom.isDescendant(e.target, a[0]) ||
          (t.style.removeClass(n.element, "open"),
          o[0].setAttribute("aria-expanded", "false"));
      };
    e.dropdown = function (e, o) {
      let i = this;
      (i.config = o || {}),
        (i.element = e),
        (i.updateCurrent = i.config.updateCurrent || !0),
        (i.callback = i.config.callback),
        (i.target = i.config.target),
        t.style.removeClass(i.element, "open"),
        (function (e) {
          let t = e.element.querySelector(".current");
          const o = e.element.parentElement.querySelector(".js-reset-button");
          e.element.getAttribute("data-listener") ||
            (e.element.setAttribute("data-listener", !0),
            e.element.addEventListener("click", n.bind(e)),
            e.element.addEventListener("keyup", function (t) {
              13 === (t.which || t.keyCode) && n.call(e, t);
            }),
            t &&
              (document.addEventListener("click", a.bind(e)),
  ...
  (function (e, t) {
    (e.event = e.event || {}),
      ...
      (e.event.PLAYLIST = {
        ...
        SET_MEDIA_MEDIA_KIND: "playlist/set-media-media-kind",
        UNLOAD_MEDIA_KIND_PLAYER: "playlist/unload-media-kind-player",
      ...
      (e.event.USER_PREFS = { SET_USER_PREFS: "user-prefs/set-user-prefs" }),
      (e.event.dispatch = function (e, n, a, o) {
        (o = t.object.extend({ bubbles: !0, cancelable: !0 }, o || {})),
          (a || document.body).dispatchEvent(
            new CustomEvent(e, {
              detail: n || {},
              bubbles: o.bubbles,
    ...
    t.fantasyAuthenticate = function () {
      ...
      t
        ? ('"' === t[0] &&
          ...
          a(JSON.parse(window.atob(t))))
        : a(null);
    };
    var a = function (t) {
      let a = document.getElementsByClassName("fantasySignIn")[0],
        o = document.getElementsByClassName("fantasySignOut")[0],
        i = n.url.updateUrlStringParam(
          e.environment.fantasyUserApi + "/",
          "redirect_uri",
          e.environment.redirectUri
        );
      ...
      a &&
        ...
        (o.href = l),
        t
          ? (n.style.addClass(a, "hide"),
            n.style.removeClass(o, "hide"),
            (o.getElementsByClassName("fantasyUsername")[0].innerHTML = t.u.fn))
          : (n.style.removeClass(a, "hide"), n.style.addClass(o, "hide"))),
        window.FDP &&
          (t && window.FDP.attachIdentity(t.u.id, "ism"),
          window.FDP.init(),
          window.FDP.view());
    };
  })(PULSE.app, PULSE.app.common, PULSE.core, PULSE.app.templates, PULSE.I18N),
  (function (e) {
    ...
    (e.fixtureListener = function () {}),
      (e.fixtureListener.prototype.redirectToMatchCenter = function (e) {
        let n = e.target,
          a = e.type,
        ...
        if (
          (((s && s.length) || l) &&
            -1 === n.className.indexOf("livestream")) ||
          i
        )
          return;
  ...
  (function (e, t, n) {
    let a = function (e, t) {
      ...
      i = function (e, t, a) {
        return (
          n.style.addClass(e, a),
          n.style.removeClass(e, t),
          n.style.addClass(e.childNodes[1].childNodes[0], a + "CaptionTitle"),
          n.style.removeClass(
            e.childNodes[1].childNodes[0],
            t + "CaptionTitle"
          ),
          n.style.addClass(e.childNodes[1].childNodes[1], a + "CaptionBody"),
          n.style.removeClass(e.childNodes[1].childNodes[1], t + "CaptionBody"),
          e
        );
      };
    (t.galleryModal = function (e) {
      let t = this;
      (t.element = e),
        (t.isWebview = n.url.getParam("webview")),
        t.isWebview ||
          ((t.gallery = {}),
          t.initModal(t),
          (function (e) {
            let t = document.createElement("div");
            n.style.addClass(t, "galleryWrapper"),
              (e.gallery.list = document.createElement("ul")),
              n.style.addClass(e.gallery.list, "galleryList"),
              t.appendChild(e.gallery.list),
              ["prev", "current", "next"].forEach(function (t) {
                ...
                n.style.addClass(s, "galleryCaptionBody"),
                  i.append(l),
                  i.append(r),
                  i.append(s),
                  a.append(o),
                  a.append(i),
                  e.gallery.list.append(a);
              }),
              e.gallery.items &&
                e.gallery.items.length > 1 &&
                ((e.gallery.prevButton = document.createElement("a")),
                (e.gallery.prevButton.tabIndex = 0),
                e.gallery.prevButton.setAttribute("alt", "Previous slide"),
                n.style.addClass(e.gallery.prevButton, "galleryNavButton"),
                n.style.addClass(e.gallery.prevButton, "prev"),
                e.gallery.prevButton.addEventListener("click", function () {
                  e.updateGallery(e, "prev");
                }),
                e.gallery.prevButton.addEventListener("keydown", function (t) {
                  13 === t.which && e.updateGallery(e, "prev");
                }),
                t.appendChild(e.gallery.prevButton),
                (e.gallery.nextButton = document.createElement("a")),
                (e.gallery.nextButton.tabIndex = 0),
                e.gallery.nextButton.setAttribute("alt", "Next slide"),
                n.style.addClass(e.gallery.nextButton, "galleryNavButton"),
                n.style.addClass(e.gallery.nextButton, "next"),
                e.gallery.nextButton.addEventListener("click", function () {
                  e.updateGallery(e, "next");
                }),
                e.gallery.nextButton.addEventListener("keydown", function (t) {
                  13 === t.which && e.updateGallery(e, "next");
                }),
                t.appendChild(e.gallery.nextButton)),
      ...
      (t.galleryModal.prototype.initModal = function () {
        ...
        let r = {
          ...
          openCallback: function (e) {
            window.matchMedia("(min-width: 1024px)").matches &&
              (t.openGallery(e), n.style.addClass(document.body, "fixedBody"));
          },
        ...
        (t.modal = new e.modal(r)),
          (t.modal.content =
            t.modal.config.modalContent.querySelector(
              '[data-widget="gallery-modal"]'
            ) || t.modal.config.modalContent),
          t.modal.content && (t.modal.content.style.display = ""),
          (t.gallery.items = []);
        for (let e = 0; e < t.element.children.length; e++)
          (t.gallery.items[e] = {}),
            (t.gallery.items[e].src = t.element.children[e].getAttribute(
              "data-ui-src",
              e
            )),
            t.element.children[e].getElementsByClassName("captionTitle")
              .length > 0 &&
              (t.gallery.items[e].captionTitle =
                t.element.children[e].getElementsByClassName(
                  "captionTitle"
                )[0].innerHTML),
            t.element.children[e].getElementsByClassName("captionBody").length >
              0 &&
              (t.gallery.items[e].captionBody =
                t.element.children[e].getElementsByClassName(
                  "captionBody"
                )[0].innerHTML),
            t.element.children[e].getElementsByClassName("captionLink").length >
              0 &&
              ((t.gallery.items[e].captionLinkText =
                t.element.children[e].getElementsByClassName(
                  "captionLink"
                )[0].innerHTML),
              (t.gallery.items[e].captionLinkUrl = t.element.children[e]
                .getElementsByClassName("captionLink")[0]
                .getAttribute("href"))),
            t.element.children[e].setAttribute("data-index", e);
      }),
      (t.galleryModal.prototype.openGallery = function (e) {
        let t = this;
        t.gallery.currentIndex = parseInt(
          e.config.current.activator
            .closest(".galleryItem")
            .getAttribute("data-index")
        );
        let n = a(t.gallery.currentIndex, t.gallery.items.length),
          i = o(t.gallery.currentIndex, t.gallery.items.length);
        t.assignSectionByIndex("current", t.gallery.currentIndex),
          t.assignSectionByIndex("prev", n),
          t.assignSectionByIndex("next", i),
          (t.gallery.sliding = !1),
          (t.gallery.isOpen = !0);
      }),
        ...
        o.setAttribute("src", n.gallery.items[t].src),
          (function (e, t) {
            if (e && t) {
              let n = !0;
              t.captionTitle &&
                ((e.childNodes[0].innerHTML = t.captionTitle), (n = !1)),
                t.captionLinkText
                  ? ((e.childNodes[1].innerHTML = t.captionLinkText),
                    e.childNodes[1].setAttribute("href", t.captionLinkUrl))
                  : (e.childNodes[1].innerHTML = ""),
                t.captionBody
                  ? ((e.childNodes[2].innerHTML = t.captionBody), (n = !1))
      ...
      (t.galleryModal.prototype.updateGallery = function (e, t) {
        if (!e.gallery.sliding) {
          ...
          if ("prev" === t) {
            e.gallery.currentIndex = a(
              e.gallery.currentIndex,
              e.gallery.items.length
            );
            let t = a(e.gallery.currentIndex, e.gallery.items.length);
            (n = i(n, "prev", "current")),
              (l = i(l, "current", "next")),
              (r = i(r, "next", "prev")),
              e.assignSectionByIndex("prev", t),
              e.gallery.list.insertBefore(r, l),
              (e.gallery.prev = r),
              (e.gallery.current = n),
              (e.gallery.next = l);
          } else {
            e.gallery.currentIndex = o(
              e.gallery.currentIndex,
              e.gallery.items.length
            );
            ...
            (r = i(r, "next", "current")),
              (l = i(l, "current", "prev")),
              (n = i(n, "prev", "next")),
              e.assignSectionByIndex("next", t),
              e.gallery.list.appendChild(n),
              (e.gallery.prev = l),
              (e.gallery.current = r),
              (e.gallery.next = n);
          }
  ...
  (function (e, t, n) {
    let a = { root: null, rootMargin: "0px", threshold: 0 };
    (n.LazyLoad = function (e) {
      let t = this;
      (t.element = e),
        (t.thumbs = []),
        (t.range = 0),
        t.setObservableListener();
    }),
      (n.LazyLoad.prototype.setObservableListener = function () {
        let e = this;
        (e.observer = new IntersectionObserver(e.onActivate.bind(e), a)),
          e.observer.observe(e.element);
      }),
        ...
        e.setAttribute("src", e.getAttribute("data-src")),
          (e.onload = function () {
            e.removeAttribute("data-src"),
              t.style.removeClass(n, "placeholder"),
              n.setAttribute("data-initialised", "true"),
              a.staggerThumbLoading();
          });
      }),
      (n.LazyLoad.prototype.onActivate = function (e) {
        ...
        Array.prototype.forEach.call(e, function (e) {
          e.isIntersecting &&
            ((t.thumbs = t.filterThumbs(
              e.target.querySelectorAll(".js-content-load")
            )),
            t.thumbs.length > 0 && t.staggerThumbLoading());
        });
      }),
      (n.LazyLoad.prototype.filterThumbs = function (e) {
        let t = [];
        for (let n = 0; n < e.length; n++)
          "false" === e[n].getAttribute("data-initialised") && t.push(e[n]);
        return t;
      }),
  ...
  (function (e, t) {
    (e.liveFixtures = function (e) {
      ...
      (t.config = e || {}),
        (t.compSeason = t.config.compSeason),
        (t.comps = t.config.comps),
        (t.gameweekNumbers = t.config.gameweekNumbers),
        (t.statuses = "L"),
        (t.callback = t.config.callback),
        (t.target = t.config.target),
      ...
      (e.liveFixtures.prototype.liveFixtures = function (e) {
        let n = this;
        e && e.content.length && t.style.removeClass(n.container, "u-hide"),
          n.callback && n.callback.call(n.target, e.content);
      }),
  ...
  (function (e) {
    ...
    (e.liveStreaming.prototype.getFixturesStreamingURLs = function (t, n) {
      return n
        ? this.streamingURLs.filter(function (a) {
            return (
              a.fixtureId === t &&
              (function (t) {
      ...
      (e.liveStreaming.prototype.getLiveStreamData = function (e, t) {
        ...
        let a = n && n.length > 0;
        return { broadcasterHasLiveStream: a, liveStreamURL: a ? n[0] : null };
      });
  })(PULSE.app),
  (function (e) {
    ...
    e.DynamicMore = function (e) {
      ...
      const n = this;
      (n.container = e),
        (n.list = e.querySelector(".js-dynamic-list")),
        (n.list.style.position = "relative"),
        (n.items = e.querySelectorAll(".js-dynamic-child")),
        (n.more = null),
        (n.template = t || "common.dynamic-more"),
        (n.bucket = o.call(n, n.list));
      const i = {
          root: n.list,
    ...
    const a = function (e) {
        ...
        const t = this,
          a = e.reduce(i, { exiting: [], entering: [] });
        a.exiting.forEach(l.bind(t)), a.entering.forEach(r.bind(t));
        t.bucket.children.length
          ? t.more.classList.remove(n)
          : t.more.classList.add(n);
      },
      o = function (t) {
        const n = e.templating.render({}, this.template, !0);
        return (
          (this.more = t.appendChild(n)),
          t.querySelector(".js-dynamic-more-bucket")
        );
      },
      i = (e, t) => (
        t.boundingClientRect.right >= t.rootBounds.right
          ? e.exiting.push(t)
          : e.entering.push(t),
        e
      ),
      l = function (e) {
        ...
        this.bucket.appendChild(n),
          e.target.classList.add(t),
          (e.target.style.left =
            e.boundingClientRect.left - e.rootBounds.left + "px");
      },
      r = function (e) {
        const n = this.bucket.querySelector(
          `[data-cloned="${e.target.getAttribute("data-cloned")}"]`
        );
        n &&
          (n.remove(),
          e.target.classList.remove(t),
          e.target.removeAttribute("data-cloned"),
  ...
  (function (e, t, n) {
    ...
    (e.MobileNavigation = function (e) {
      const n = this;
      (n.container = e),
        (n.list = e.querySelector(".js-mobile-nav")),
        (n.button = e.querySelector(`.${a}`)),
        t.addAriaClickListener(n.container, n.delegateEvent.bind(n));
    }),
      (e.MobileNavigation.prototype.delegateEvent = function (e) {
        const t = this;
        if (
          (e.target.classList.contains(a) && t.toggleMenu(),
          e.target.classList.contains(o))
        ) {
          let n = t.list.querySelectorAll(`.${o} + .${l}`);
          [].slice.call(n, t.toggleDropdown),
            t.toggleDropdown(e.target.nextElementSibling);
        }
      }),
      (e.MobileNavigation.prototype.toggleMenu = function () {
        n.style.toggleClass(this.list, l),
          n.style.toggleClass(this.button, "is-active");
      }),
      (e.MobileNavigation.prototype.toggleDropdown = function (e) {
        const t = this;
        n.style.toggleClass(e, l),
          t.list.querySelectorAll(`.${o} + .${l}`).length
            ? n.style.addClass(t.list, i)
            : n.style.removeClass(t.list, i);
      }),
      e.widgetInitialiser.addMultipleWidgetsByName(
        "mobile-navigation",
        e.MobileNavigation
  ...
  (function (e, t, n) {
    ...
    (n.Modal = function (e, t) {
      ...
      (c.root = e),
        (c.imageSelector = a),
        (c.containerSelector = t.containerSelector || o),
        (c.modalSelector = t.modalSelector || i),
        (c.modalMarker = t.modalMarker || l),
        (c.renderModal = t.renderModal || r()),
        (c.onDomUpdate = t.onDomUpdate || s()),
        (c.modal = null),
        (c.ancestor = null),
        (c.container = document.querySelector(c.containerSelector)),
        c.container && n.addAriaClickListener(c.root, c.delegateClick.bind(c));
    }),
      (n.Modal.prototype.doModal = function (e) {
        ...
        n &&
          (t.modal
            ? (t.modal.outerHTML = n)
            : t.container.insertAdjacentHTML("beforeend", n),
          (t.modal = t.container.querySelector(t.modalSelector)),
          t.onDomUpdate(t.modal));
      }),
      (n.Modal.prototype.delegateClick = function (e) {
        const t = this;
        (t.ancestor = e.target.closest(t.modalMarker)),
          t.ancestor && (e.preventDefault(), t.doModal(t.ancestor));
      }),
      (n.Modal.prototype.closeModalInstance = function () {
        const e = this;
        e.boundEvents && n.removeAriaClickListener(e.modal, e.boundEvents),
          e.modal.remove(),
          (e.modal = null);
      });
    const c = function (t) {
        ...
        return e.templating.render({ data: a, PULSE: PULSE }, "common.modal");
      },
      d = function (t) {
      ...
      p = function (e) {
        ...
        if (
          ("prev" === n
            ? (a = t.ancestor.previousElementSibling)
            : "next" === n && (a = t.ancestor.nextElementSibling),
          a && void 0 !== a.dataset.modal)
        )
          return t.closeModalInstance(), void a.click();
      ...
      m = function (e) {
        ...
        o ? t.style.removeClass(n, "disable") : t.style.addClass(n, "disable"),
          i
            ? t.style.removeClass(a, "disable")
            : t.style.addClass(a, "disable");
      };
  })(PULSE.app, PULSE.core, PULSE.app.common),
  (function (e, t, n, a, o) {
    (t.pollMatches = function (e, t, n) {
      ...
      (a.element = e),
        (a.config = n),
        (a.matchClass =
          a.config && a.config.matchClass
            ? a.config.matchClass
            : "matchNavMatchContainer"),
        (a.requestConfig = t),
        (a.matchNavMatchContainer = a.element.getElementsByClassName(
          a.matchClass
        )),
        e && a.requestConfig && a.initData();
    }),
      ...
      (t.pollMatches.prototype.renderMatches = function (e) {
        ...
        (t.hasLiveMatch = !1),
          e &&
            e.content &&
            Array.prototype.map.call(t.matchNavMatchContainer, function (n) {
      ...
      (t.pollMatches.prototype.renderMatch = function (e, n) {
        ...
        if (n.status && "U" != n.status) {
          ...
          if (l && l.length > 0 && r && r.length > 0) {
            let s = [
              null != n.teams[0].score ? n.teams[0].score : "",
              null != n.teams[1].score ? n.teams[1].score : "",
            ];
            if ("C" === n.status)
              (e.className = i.matchClass + " matchAbridged fullTime"),
                (l[0].innerHTML = o.lookup("label.match.fulltime.short"));
            else if ("A" === n.status) {
              ...
              (i.hasLiveMatch = !0),
                (e.className = i.matchClass + " matchAbridged live");
              let a = "";
              "H" === n.phase
                ? (a = o.lookup("label.match.halftime.short"))
                : n.clock && (a = t.getEventTime(n)),
                (l[0].innerHTML = a);
            }
            l[0].style.display = "";
            let c = { scores: s };
  ...
  (function (e, t, n, a) {
    (n.QuizList = function (e) {
      let n = this;
      (n.container = e),
        (n.quizListContainer = n.container.querySelector(
          ".js-quiz-list-container"
        )),
        (n.showFeatured =
          "true" === n.container.getAttribute("data-show-featured")),
        (n.items = n.container.dataset.items),
        (n.tags = n.container.dataset.tags),
        (n.template = n.showFeatured ? "quizListFeatured" : "quizList"),
        (n.loader = n.container.querySelector(".js-loader")),
        (n.isFullPageQuizList = t.style.hasClass(
          n.container,
          "quiz-full-list"
        )),
        n.isFullPageQuizList &&
          (n.quizId = parseInt(n.container.getAttribute("data-quiz-id"))),
        n.getQuizList();
    }),
      ...
      (n.QuizList.prototype.renderQuizzes = function (t) {
        let o = this,
          i = {};
        if (
          ((i.hasFeatured = o.showFeatured), t?.pagedResult?.content?.length)
        ) {
          (i.list = []),
            t.pagedResult.content.forEach(function (e, t) {
              (o.isFullPageQuizList &&
                (i.list.length >= 6 || e.id === o.quizId)) ||
                i.list.push({
                  ...
                  url: n.generateContentUrl(
                    "quizzes",
                    e.id,
                    e.title.replace(new RegExp(" ", "g"), "-")
                  ),
                  thumbnailUrl: e.leadMedia
                    ? n.getImageUrl(e.leadMedia, "436", "254")
                    : "",
                  featuredThumbnailUrl: e.leadMedia
                    ? n.getImageUrl(e.leadMedia, "1076", "606")
                    : "",
                  resourceVersion: window.RESOURCE_VERSION,
                  generalTag: a.lookup("label.quiz.tagGeneral"),
                });
            }),
            (o.quizListContainer.innerHTML = Mustache.render(
              e.templates[o.template],
              i
            )),
            o.hideLoader();
        }
  ...
  (function (e, t, n, a) {
    const o = {
      ...
      i = function (e) {
        ...
        (t.element.innerHTML = Mustache.render(n.search, {
          ...
          (t.searchTextContainer = t.element.getElementsByClassName(
            "searchTextContainer"
          )[0]),
          (t.searchIconContainer = t.element.getElementsByClassName(
            "searchIconContainer"
          )[0]),
          (t.searchKeyPressContainer = [
            t.searchTextContainer,
            t.searchIconContainer,
          ]),
          (t.emptyInputBtn = t.element.querySelector(".js-empty-input-btn"));
      };
    let l = function () {
        const e = this;
        for (let t = 0; t < e.searchKeyPressContainer.length; t++)
          e.searchKeyPressContainer[t].addEventListener(
            "keypress",
            function (t) {
        ...
        e.searchTextContainer.addEventListener("keyup", () => {
          e.searchTextContainer.value.length > 0
      ...
      r = function (e) {
        ...
        if (
          (e.object_id &&
            e.object_id.length > 0 &&
            (t.id = parseInt(e.object_id[0])),
          e.type && e.type.length > 0)
        )
          switch (
            (e.object_id && e.object_id.length > 0 && (t.id = e.object_id[0]),
            e.type && e.type.length > 0 && (t.type = e.type[0].toLowerCase()),
            e.type[0])
          ) {
            case "PLAYER":
            case "TOFFICIAL":
              e.title &&
                e.title.length > 0 &&
                (t.name = { display: e.title[0] }),
                e.object_id &&
                  e.object_id.length > 0 &&
                  (t.personId = e.object_id[0]);
              break;
            case "TEAM":
              e.title && e.title.length > 0 && (t.name = e.title[0]);
              break;
            case "VIDEO":
              e.title && e.title.length > 0 && (t.title = e.title[0]),
                e.image_url &&
                  e.image_url.length > 0 &&
                  (t.thumbnailUrl = (function (e) {
                    let t = [];
                    if (e && e.length > 0)
                      for (let n = 0; n < e.length; n++) {
                        const a = new URL(e[n]).searchParams;
                        parseInt(a.get("width")) >
                          1.2 * parseInt(a.get("height")) && t.push(e[n]);
                      }
                    return t[0];
                  })(e.image_url)),
                e.duration &&
                ...
                e.description &&
                  ...
                  (t.description = e.description[0]),
                e.timestamp &&
                  e.timestamp.length > 0 &&
                  (t.date = e.timestamp[0]),
                e.tags && e.tags.length > 0 && (t.tags = e.tags);
              break;
            case "PHOTO":
              e.title && e.title.length > 0 && (t.title = e.title[0]),
                e.timestamp &&
            ...
            case "TEXT":
              e.title && e.title.length > 0 && (t.title = e.title[0]),
                ...
                e.description &&
                  e.description.length > 0 &&
                  (t.description = e.description[0]),
                e.body && e.body.length > 0 && (t.body = e.body[0]),
                e.tags && e.tags.length > 0 && (t.tags = e.tags);
          }
        return t;
      };
    (e.search = function (e, t) {
      ...
      (e.search.prototype.checkParam = function () {
        ...
        n &&
          ((e.searchTextContainer.value = n),
          e.element.classList.add("is-active"),
          a
            ? (e.doSearch(n, !0), e.config.target.tabs.showTabByIndex(o[a]))
            : e.doSearch(n, !0, i));
      }),
      (e.search.prototype.doSearch = function (n, a, o) {
        ...
        i.config.callback &&
          i.config.target &&
          i.config.callback.call(i.config.target, l, 0, o),
          i.config.updateUrl &&
            !a &&
            ((i.url = t.url.updateUrlStringParam(
              window.location.href,
              "term",
              l
            )),
            history.pushState({}, "", i.url));
      }),
      ...
      (e.search.prototype.getSearchParams = function (e) {
        ...
        return (
          e &&
            (void 0 !== e.pageSize &&
              void 0 !== e.page &&
              ((t.size = e.pageSize), (t.start = e.pageSize * e.page)),
            e.fullObjectResponse && (t.fullObjectResponse = !0),
      ...
      (e.search.prototype.evaluateHits = function (t) {
        ...
        return (
          t &&
            t.hit &&
            t.hit.length > 0 &&
            t.hit.forEach(function (t) {
              if (t.fields) {
                let o = !1;
                t.fields.tags &&
                  (o =
                    t.fields.tags.includes("highlighted-content") ||
                    e.content.hasTag(t.fields, "highlighted-content")),
                  n && !o ? a.push(r(t.fields)) : n || a.push(r(t.fields));
              } else if (t.response) {
                "FOOTBALL_PERSON" === t.contentType &&
                  (t.response.type = "player");
                let o = !1;
                t.response.tags &&
                  (o =
                    t.response.tags.includes("highlighted-content") ||
                    e.content.hasTag(t.response, "highlighted-content")),
                  n && !o ? a.push(t.response) : n || a.push(t.response);
              }
            }),
          a
        );
  ...
  (function (e, t, n) {
    const a = [
        { namespace: "container", elementType: HTMLElement },
        { namespace: "scrollContainer", elementType: HTMLElement },
        { namespace: "sliderElements", elementType: NodeList },
        { namespace: "nextButton", elementType: HTMLElement },
        { namespace: "prevButton", elementType: HTMLElement },
        { namespace: "scrollList", elementType: HTMLElement },
        { namespace: "paginatorContainer", elementType: HTMLElement },
      ],
      o = "u-hide";
    (t.ContentCarousel = function (e) {
      ...
      (t.ContentCarousel.prototype.initSlider = function () {
        const e = this;
        (e.element = e.config.container),
          (e.slideContainer = e.config.scrollContainer),
          (e.slideWidth = e.slideContainer.clientWidth),
          (e.slideItems = e.config.sliderElements),
          (e.itemsPerPage = parseInt(e.config.itemsPerPage)),
          (e.slideNum = Math.ceil(e.slideItems.length / e.itemsPerPage)),
          (e.slidePos = 0),
          (e.activeSlide = 0),
          (e.slideElementWidth = e.slideItems[0].clientWidth * e.itemsPerPage),
          (e.nextBtn = e.config.nextButton),
          (e.prevBtn = e.config.prevButton),
          (e.paginatorContainer = e.config.paginatorContainer),
          (e.fullScroll = !0),
          (e.itemsLeft = e.slideItems.length),
          e.setListeners(),
          e.updateControls(),
          e.resetSlider();
      }),
      (t.ContentCarousel.prototype.setListeners = function () {
        const e = this;
        e.nextBtn &&
          (t.addAriaClickListener(e.nextBtn, function () {
            e.scrollNext();
          }),
          ...
          e.prevBtn &&
            (e.prevBtn.addEventListener("mouseover", function () {
              e.nudgeRight();
            }),
          ...
          n.event.windowResize.add({ method: e.resetSlider.bind(e) }),
          e.paginatorContainer && e.renderPaginator();
      }),
      (t.ContentCarousel.prototype.renderPaginator = function () {
        const a = this;
        a.slideNum > 1
          ? ((a.paginatorContainer.innerHTML = e.templating.render(
              { slideNum: a.slideNum },
              "common.paginator"
            )),
            (a.pagerContainers =
              a.element.getElementsByClassName("js-pager-container")),
            (a.pagers = a.element.getElementsByClassName("js-pager")),
            n.style.addClass(a.pagers[0], "is-active"),
            [].forEach.call(a.pagerContainers, (e, n) => {
              t.addAriaClickListener(e, (e) => {
                (a.activeSlide = n),
                  a.slideTo(a.activeSlide),
                  e.stopPropagation();
              });
            }),
            n.style.removeClass(a.prevBtn, o),
            n.style.removeClass(a.nextBtn, o))
          : (a.prevBtn && n.style.addClass(a.prevBtn, o),
            a.nextBtn && n.style.addClass(a.nextBtn, o));
      }),
      (t.ContentCarousel.prototype.scrollNext = function () {
        const e = this;
        e.activeSlide++,
          e.slideTo(e.activeSlide),
          e.updateControls(),
          e.setActiveItems();
      }),
      ...
      (t.ContentCarousel.prototype.isPaginating = function () {
        return (
          !!this.pagerItemsContainer && this.pagerItemsContainer.offsetParent
        );
      }),
      ...
      (t.ContentCarousel.prototype.getItemsLeft = function () {
        const e = this;
        (e.itemsLeft = e.slideItems.length - e.activeSlide * e.itemsPerPage),
          e.itemsLeft < e.itemsPerPage
            ? (e.fullScroll = !1)
            : (e.fullScroll = !0);
      }),
      (t.ContentCarousel.prototype.scrollSlider = function () {
        const e = this;
        e.fullScroll
          ? ((e.slidePos = e.slideElementWidth * e.activeSlide),
            (e.slideContainer.style.left = "-" + e.slidePos + "px"))
          : ((e.slidePos =
              e.slideElementWidth * e.activeSlide -
              e.slideItems[0].clientWidth * (e.itemsPerPage - e.itemsLeft)),
            (e.slideContainer.style.left = "-" + e.slidePos + "px"));
      }),
      (t.ContentCarousel.prototype.updateControls = function () {
        const e = this;
        if (
          (e.activeSlide >= e.slideNum - 1 && e.nextBtn
            ? n.style.addClass(e.nextBtn, "faded")
            : e.nextBtn &&
              n.style.hasClass(e.nextBtn, "faded") &&
              n.style.removeClass(e.nextBtn, "faded"),
          0 === e.activeSlide && e.prevBtn
            ? n.style.addClass(e.prevBtn, "faded")
            : e.prevBtn &&
              n.style.hasClass(e.prevBtn, "faded") &&
              n.style.removeClass(e.prevBtn, "faded"),
          e.paginatorContainer && e.pagers)
        )
          for (let t = 0; t < e.pagers.length; t++)
            t === e.activeSlide
              ? n.style.addClass(e.pagers[t], "is-active")
              : n.style.removeClass(e.pagers[t], "is-active");
      }),
      ...
      (t.ContentCarousel.prototype.setActiveItems = function () {
        const e = this;
        let t;
        for (var a = 0; a < e.slideItems.length; a++)
          n.style.removeClass(e.slideItems[a], "is-active");
        for (
          t = e.fullScroll
            ? e.activeSlide * e.itemsPerPage
            : e.activeSlide * e.itemsPerPage - (e.itemsPerPage - e.itemsLeft),
            a = 0;
          a < e.itemsPerPage;
          a++
        )
          n.style.addClass(e.slideItems[t], "is-active"), t++;
      }),
      ...
      (t.ContentCarousel.prototype.resetSlider = function () {
        ...
        (t.slidePos = 0),
          (t.slideElementWidth = t.slideItems[0].clientWidth * t.itemsPerPage),
          (t.slideNum = Math.ceil(t.slideItems.length / t.itemsPerPage)),
          (t.activeSlide = 0),
          t.renderPaginator(),
          t.slideTo(t.activeSlide);
      });
  })(PULSE.app, PULSE.app.common, PULSE.core),
  (function (e, t, n) {
    (n.ContentList = function (e) {
      const t = this;
      (t.element = e),
        (t.itemsPerPage = t.element.getAttribute("data-items-per-page")),
        (t.slideContainer = t.element.querySelector(
          ".js-content-slider-content"
        )),
        (t.sliderElements = t.slideContainer.querySelectorAll(".js-thumb")),
        (t.nextBtn = t.element.querySelector(".js-slide-next")),
        (t.prevBtn = t.element.querySelector(".js-slide-prev")),
        (t.scrollList = t.element.querySelector(".js-scroll-list")),
        (t.paginatorContainer = t.element.querySelector(".js-paginator")),
        (t.itemsPerPageDesktop =
          t.element.getAttribute("data-items-per-page-desktop") || ""),
        (t.itemsPerPageTablet =
          t.element.getAttribute("data-items-per-page-tablet") || "");
      const a = {
        container: t.element,
  ...
  (function (e, t, n) {
    ...
    (n.SharePage = function (e, t) {
      const n = this;
      (n.element = e),
        (n.render = n.element.getAttribute("data-render")),
        (n.bodyContent = n.element.getAttribute("data-body")),
        (n.defaultClosed = n.element.getAttribute("data-closed")),
        (n.copyBtn = n.element.querySelector(a)),
        (n.copyMessage = n.element.querySelector(o)),
        (n.url = n.element.getAttribute("data-link-to")
          ? window.location.hostname + n.element.getAttribute("data-link-to")
          : t),
        n.defaultClosed &&
          ((n.toggleButton = n.element.querySelector(i)),
          (n.closeButton = n.element.querySelector(l)),
          (n.shareSvg = n.element.querySelector(r)),
          (n.closeSvg = n.element.querySelector(s)),
          n.setExpandableListeners()),
        n.setListeners();
    }),
      (n.SharePage.prototype.setExpandableListeners = function () {
        const e = this;
        n.addAriaClickListener(e.toggleButton, function () {
          e.element.classList.toggle(c),
            e.closeSvg &&
              e.shareSvg &&
              (e.closeSvg.classList.toggle(d), e.shareSvg.classList.toggle(d));
        }),
      ...
      (n.SharePage.prototype.setListeners = function () {
        ...
        n.addAriaClickListener(t.element, (n) => {
          ...
          document.queryCommandSupported("copy")
            ? n.addAriaClickListener(t.copyBtn, () => t.copyUrl())
            : t.copyButton.classList.add(d);
      }),
      (n.SharePage.prototype.copyUrl = function () {
        const e = this,
          t = e.url || window.location.href;
        clipboard.writeText(t).then(
          () => e.copyUrlMessage(),
          () => e.copyUrlMessage(!0)
        );
      }),
      (n.SharePage.prototype.copyUrlMessage = function (e) {
        const t = this;
        t.copyBtn.classList.add(u),
          e &&
            (t.copyMessage.classList.add(p),
            (t.copyMessage.innerHTML = "URL could not be copied")),
          setTimeout(function () {
      ...
      (n.SharePage.prototype.getSocialDataset = function (e) {
        const t = this;
        let n = e;
        if (t.element.getAttribute("data-social-service"))
          return t.element.dataset;
        do {
  ...
  (function (e) {
    ...
    (r.prototype.buildShareUrl = function (e, r) {
      ...
      switch (c.name) {
        ...
        case t:
          return r
            ? p + encodeURIComponent(`${r} ${i()} ${d}`)
            : u
            ? p + encodeURIComponent(`${u} ${i()} ${d}`)
            : p + encodeURIComponent(`${d} ${i()}`);
        default:
          return u
            ? p + encodeURIComponent(`${u} ${l()} ${d}`)
            : p + encodeURIComponent(`${r} ${l()} ${d}`);
      }
    }),
  ...
  (function (e, t) {
    const n = t,
      { initialState: a } = t,
      o = "production" !== e.environment.label;
    e.reduxStore = function () {
      const e = n.combineReducers({
          contentApi: t?.contentApi?.reducer,
          plApi: t?.plApi?.reducer,
        }),
        i = PULSE.app.redux.createListenerMiddleware();
      t.configureStore &&
        (t.store = t.configureStore({
          reducer: e,
          middleware: (e) =>
            e({ immutableCheck: !1 })
              .prepend(i.middleware)
              .concat(t.contentApi.middleware)
              .concat(t.plApi.middleware),
          devTools: o,
          preloadedState: a,
        }));
    };
  ...
  (function (e) {
    (e.tabAwareWidgets = []),
      (e.tabAwareWidget = function (t) {
        let n = this;
        (n.widgetInit = t),
          (n.tabbed = !1),
          (n.initialised = !1),
          e.tabAwareWidgets.push(n);
        let a =
            "true" ===
            n.widgetInit.widgetElement.getAttribute("data-tab-aware-default"),
          o = !(
            n.widgetInit.widgetElement.parentElement &&
            n.widgetInit.widgetElement.parentElement.classList.contains(
              "tabbedContent"
            )
          );
        (a || o) && n.activate();
      ...
      (e.tabAwareWidget.prototype.createWidget = function () {
        let e = this;
        new e.widgetInit.widgetConstructor(
          e.widgetInit.widgetElement,
          e.widgetInit.widgetConfig
        );
      });
  })(PULSE.app);
var Mustache = (function (e) {
  ...
  return (
    (e.render = function (e, o, i) {
      return (
        (o.externalLinkText = "External Link"),
        (o.resourceVersion = n),
        (o.baseResourceURL = a),
        t(e, o, i)
      );
...
!(function (e, t, n) {
  ...
  (t.hasPersonalisationFlag = function () {
    return (
      "true" ===
      new URLSearchParams(window.location.search).get("personalisation")
    );
  }),
    (t.getUserAccount = function (t) {
      ...
      if (o) {
        ...
        fetch(e.environment.userAccount, {
          headers: { Authorization: `Bearer ${JSON.parse(n).s}` },
        })
          .then((e) => e.json())
          .then((e) => {
            let a = e;
            a?.first_name
              ? ((a.signedIn = !0), (a.userToken = JSON.parse(n).s))
              : (a = { signedIn: !1 }),
              (window.userProfile = a),
              t(a);
          })
    ...
    e.UserData = new (function () {
      ...
      const o = function () {
          ...
          if (n) {
            ...
            e && (a = JSON.parse(e)),
              (a.plProfile = JSON.parse(window.atob(n))),
              (a.loggedin = !0);
        ...
        i = function () {
          if (
            a.loggedin &&
            (!a.club || !a.club.opta || a.club.opta !== a.plProfile.u.fc) &&
            ((a.club = { opta: a.plProfile.u.fc }), a.club.opta)
          ) {
            let n = {
              url:
                e.environment.api +
        ...
        l = function (e) {
          e &&
            e.club &&
            ((a.club.id = e.club.id),
            (a.club.abbr = e.club.abbr),
            (a.club.name = e.club.name),
            (a.club.shortName = e.club.shortName),
            (a.club.grounds = e.grounds),
            r());
        },
        r = function () {
  ...
  (PULSE.app.common.scrollElementAnimated = function (e, t, n, a, o) {
    let i,
    ...
    i = s
      ...
      : requestAnimationFrame(function e() {
          ...
          t >= r || s
            ? (cancelAnimationFrame(i), "function" == typeof o && o())
            : requestAnimationFrame(e);
        });
  }),
  (function (e, t, n, a) {
    ...
    (n.videoList = function (e) {
      ...
      (n.videoList.prototype.initModal = function () {
        ...
        (o = window.location.href),
          (n.eventTarget = document.querySelector("body"));
        let i = {
          parent: n.element,
        ...
        (n.modal = new t.modal(i)),
          e.modalsController.addModal(n.modal),
          i.modifierClass &&
            n.modal.config.modal &&
            a.style.addClass(n.modal.config.modal, i.modifierClass);
      }),
      (n.videoList.prototype.updatePlayer = function (t) {
        let a = this,
          i = t.config.modal.querySelector("[data-player]");
        if (i) {
          let t = i.getAttribute("id");
          a.player = e.videoPlayerManager.getPlayerWithName(t);
        }
        let l = t.config.current.uiArgs.mediaId,
          r = t.config.current.uiArgs.contentId,
          s = t.config.current.uiArgs.platform;
        (a.newUrl = n.generateContentUrl("video", r)),
          history.pushState({}, "", a.newUrl),
          (window.onpopstate = function () {
            window.location.href = o;
          });
        a.playVideo({ id: r, mediaId: l, platform: s });
      }),
      (n.videoList.prototype.playVideo = function (t) {
        let a = this,
          o = a.modal.config.modalContentWrapClass || "",
          i = document.getElementsByClassName(o);
        n.content.videoIsBrightcove(t) ||
          n.event.dispatch(
            e.common.event.PLAYLIST.SET_MEDIA_MEDIA_KIND,
            { video: t },
            document.body
          ),
          i.length > 0 &&
            i[0].addEventListener("click", function (e) {
              e.target.className === o && a.modal.close();
            });
      }),
      (n.videoList.prototype.stopPlayer = function (t) {
        let n = t.config.modal
      ...
      (n.videoList.prototype.resetPlayer = function (t) {
        if (t.config.modal.querySelector("[data-player]")) {
          let n = t.config.modal
              .querySelector("[data-player]")
              .getAttribute("id"),
            a = e.videoPlayerManager.getPlayerWithName(n);
        ...
        n.event.dispatch(
          e.common.event.PLAYLIST.UNLOAD_MEDIA_KIND_PLAYER,
          {},
          document.body
        );
      });
  })(PULSE.app, PULSE.ui, PULSE.app.common, PULSE.core),
  (window.isCommonLoaded = !0),
  window.dispatchEvent(
    new CustomEvent(PULSE.app.common.constants.EVENTS.SCRIPTS.COMMON.LOADED)
  );

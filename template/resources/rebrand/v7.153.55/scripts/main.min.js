...
!(function (a) {
  switch (
    ...
    (a.account = "PremierLeague"),
    (a.defaultCompCode = "EN_PR"),
    (a.canaryAccount = "10"),
    (a.accountHeader = { label: "account", value: "premierleague" }),
    (a.cookiePolicyExpiry = 90),
    (a.premierLeagueHandbook =
      "http://pulse-static-files.s3.amazonaws.com/premierleague/document/2016/08/09/b81992f4-cf2a-4c5e-a9c1-155169074163/2016-17_Premier_League_Handbook.pdf"),
    (a.pollingCacheRate = 2e4),
    (a.photoVariants = {
    ...
    (a.competition = { FIRST: 1, U21: [16, 17], U18: 8 }),
    (a.competitionTeams = {
      1: [
        127, 1, 2, 130, 131, 4, 6, 7, 34, 8, 26, 10, 11, 12, 23, 15, 20, 21, 25,
        38,
      ],
      16: [385, 336, 337, 339, 343, 344, 381, 387, 355, 356, 383, 358],
      17: [386, 332, 334, 341, 345, 346, 347, 351, 352, 354, 357, 360],
      8: [
        296, 300, 302, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317,
        318, 319, 320, 321, 323, 324, 327, 328, 329, 330,
      ],
    }),
    (a.competitionMatchCentres = [
      1, 16, 17, 8, 9, 6, 10, 7, 10, 18, 102, 103, 220, 219, 2088, 2096, 182,
      313, 315, 3823, 3470,
    ]),
    (a.leagueOnlyComps = [1, 16, 182, 313, 3470]),
    (a.startDates = {
      1: "1992-01-01",
      2: "2014-01-01",
      3: "2014-01-01",
    ...
    (a.paths = [
      {
        ...
        playerAppApi: "//api.premierleague.pulselive.com",
        cms: "//footballapi.pulselive.com/content/PremierLeague",
        crm: "//crm.premierleague.pulselive.com/premierleague/eventgroup/en/13",
        playerImagePath:
          "https://resources.premierleague.com/premierleague/photos/players/",
        kotmPlayerImagePath:
          "https://resources.premierleague.com/premierleague/photos/players/kotm/",
        broadcasterLogo:
          "https://resources.premierleague.com/premierleague/broadcasters/",
        badges: "https://resources.premierleague.com/premierleague/badges/",
        flags: "https://resources.premierleague.com/premierleague/flags/",
        competitionLogo:
          "https://resources.premierleague.com/premierleague/competitions/",
        fantasyUserApi: "https://users.premierleague.com",
        fantasyAppId: "pl-web",
        redirectUri: "https://www.premierleague.com/",
        pollQuestions:
          "https://resources.premierleague.com/dynamic/data/livewire",
        trackingApi:
          "https://jkulhg7io5.execute-api.us-east-1.amazonaws.com/prod/interactions",
        dataCapture:
          "https://pl-data-capture.premier-league-prod.pulselive.com/user-data-form/",
        ...
        competition: { FIRST: 1, U21: [16, 17], U18: 8 },
        competitionTeams: {
          16: [385, 336, 337, 339, 343, 344, 381, 387, 355, 356, 383, 358],
          17: [386, 332, 334, 341, 345, 346, 347, 351, 352, 354, 357, 360],
        },
        ...
        mediaKindKey: "740c55b3-982d-4f58-8302-ddabe7e9a642",
        mediaKindAnalyticsKey: "e18cd098-12bd-408e-89e1-eee164ae5699",
        locationApi:
          "https://jmidiufjtd.execute-api.eu-west-1.amazonaws.com/prod/country",
      },
    ]),
    (a.checkEnvironment = function () {
      ...
      for (let o = 0; o < a.paths.length; o++) {
        const n = a.paths[o];
        if (
          ("undefined" != typeof browsersyncProxy &&
            ("localhost" === i ||
          ...
          const t = a.paths.findIndex(
            (a) => a.domain.indexOf(browsersyncProxy) > -1
          );
          (e = a.paths[t]), (e.cdn = "/");
          break;
        }
        i === n.domain &&
          ((e = n),
          (e.cdn = `${window.BASE_RESOURCE_URL}/${window.RESOURCE_VERSION}/`)),
          "production" === n.label && (t = n);
      }
      return e || t;
    }),
    (a.environment = a.checkEnvironment()),
    (a.cookiePrefix = "pl_"),
    (a.cmpVendorCookieName = "oob-vendors"),
    (a.essentialCookies = [
      { name: "pl_store-all-cookies", expiry: "100" },
      { name: "pl_profile", expiry: "100" },
      { name: "csrftoken", expiry: "100" },
      { name: "sessionId", expiry: "100" },
      { name: "one-click-join", expiry: "100" },
      { name: "Matchweekpoll", expiry: "100" },
      { name: "XSFR-TOKEN", expiry: "100" },
    ]),
    (a.pl_domain = ".premierleague.com"),
    (a.pulse_domain = ".pulselive.com"),
    a.environment.label)
  ) {
    case "development":
      (a.newSeason = { FIRST: window.PL_COMPSEASON_ID, U18: 344 }),
        (a.lastSeason = {
          FIRST: 664,
          U21_DIV_1: 431,
          U21_DIV_2: 313,
        ...
        a.competitions.FIRST.splice(1, 0, 182),
        (a.summerSeries = 182),
        (a.kotmSeason = 257),
        (a.budAwardSeason = 257),
        (a.statCompSeasons = {
          U21: [
            98, 90, 192, 315, 343, 99, 96, 198, 313, 342, 343, 403, 410, 430,
            431, 429, 312, 541, 468,
          ],
          U18: [60, 89, 201, 310, 344, 312, 428, 421, 425, 41, 514, 518, 397],
        }),
        (a.eflCupCarabaoCompSeasonIds = [82, 189, 264, 375, 401, 426]),
        a.competitions.U18.push(102, 103, 216);
      break;
    case "test":
      (a.newSeason = { FIRST: window.PL_COMPSEASON_ID, U18: 379 }),
        (a.lastSeason = {
          FIRST: 589,
          U21_DIV_1: 623,
          U21_DIV_2: 337,
        ...
        (a.kotmSeason = 301),
        (a.budAwardSeason = 301),
        (a.statCompSeasons = {
          U21: [
            98, 90, 199, 344, 381, 99, 96, 200, 337, 382, 463, 471, 508, 511,
            518, 530, 541, 483, 347, 623, 624, 632, 647,
          ],
          U18: [
            60, 89, 201, 335, 379, 509, 491, 482, 509, 516, 519, 539, 540, 625,
            630, 648, 649, 650, 651,
          ],
        }),
        a.competitions.FIRST.splice(1, 0, 313),
        (a.summerSeries = 313),
        (a.eflCupCarabaoCompSeasonIds = [82, 197, 309, 386, 448, 507]),
        a.competitions.FIRST.push(238),
        a.competitions.U18.push(220, 219, 315);
      break;
    default:
      (a.newSeason = { FIRST: window.PL_COMPSEASON_ID, U18: 434 }),
        (a.lastSeason = {
          FIRST: 489,
          U21_DIV_1: 375,
          U21_DIV_2: 376,
        ...
        (a.kotmSeason = 274),
        (a.budAwardSeason = 274),
        (a.statCompSeasons = {
          U21: [
            59, 90, 96, 98, 99, 217, 218, 295, 294, 375, 376, 438, 447, 515,
            516, 523, 517, 519, 670, 672, 677, 678, 749,
          ],
          U18: [
            60, 89, 220, 296, 378, 434, 514, 518, 527, 529, 533, 673, 674, 682,
            683, 684, 685, 748,
          ],
        }),
        a.competitions.FIRST.splice(1, 0, 3470),
        (a.summerSeries = 3470),
        (a.eflCupCarabaoCompSeasonIds = [82, 212, 279, 368, 429, 505]),
        a.competitions.FIRST.push(2247),
        a.competitions.U18.push(2088, 2096, 3823),
        a.competitions.U21.push(7666);
  }
  (a.newSeasonStructure = {
    ...
    structure: [{ id: 172, type: "L", current: !0, gameweekRange: [1, 38] }],
  }),
    (a.apiPath = {
      clubs: { all: "/clubs", single: "/clubs/{id}" },
      competition: {
        all: "/competitions",
      ...
      gameweeks: { single: "/gameweeks/{id}" },
      grounds: { all: "/grounds", single: "/grounds/{id}" },
      players: {
        all: "/players",
        single: "/players/{id}",
      ...
      "match-officials": { all: "/matchofficials" },
      cms: {
    ...
    (a.fantasyEnvironment = "https://api.fantasy.premierleague.com"),
    (a.fantasyHeader = "68bb88ecee1a4484bf1dccafc2be74a6"),
    (a.fantasyPath = {
      events: "/events/",
      elements: { all: "/elements/", club: "/elements/?team_code=" },
    }),
    (a.utmTracking = {
      default:
        "?utm_source=premier-league-website&utm_campaign=website&utm_medium=link",
    }),
    (a.premierLeagueOffice = { Latitude: 51.51911, Longitude: -0.17774 }),
    (a.premierLeague = { email: "info@premierleague.com" }),
    (a.googleMapsKey = "AIzaSyBekXQgAhHag7PT-1B7VNSYYp8gxmreYLY"),
    (a.financialStandingsInfoClubIds = [1, 6, 11, 25, 43]);
})(PULSE.app),
  (function (a) {
    (a.filterData = {
      nationalities: [
        { optionName: "England", optionId: "GB-ENG" },
        { optionName: "Northern Ireland", optionId: "GB-NIR" },
        { optionName: "Ireland", optionId: "IE" },
        { optionName: "Scotland", optionId: "GB-SCT" },
        { optionName: "Wales", optionId: "GB-WLS" },
        { optionName: "Albania", optionId: "AL" },
        { optionName: "Algeria", optionId: "DZ" },
        { optionName: "Angola", optionId: "AO" },
        { optionName: "Antarctica", optionId: "AQ" },
        { optionName: "Antigua and Barbuda", optionId: "AG" },
        { optionName: "Argentina", optionId: "AR" },
        { optionName: "Armenia", optionId: "AM" },
        { optionName: "Australia", optionId: "AU" },
        { optionName: "Austria", optionId: "AT" },
        { optionName: "Bahamas", optionId: "BS" },
        { optionName: "Barbados", optionId: "BB" },
        { optionName: "Belarus", optionId: "BY" },
        { optionName: "Belgium", optionId: "BE" },
        { optionName: "Benin", optionId: "BJ" },
        { optionName: "Bermuda", optionId: "BM" },
        { optionName: "Bolivia, Plurinational State of", optionId: "BO" },
        { optionName: "Bosnia and Herzegovina", optionId: "BA" },
        { optionName: "Brazil", optionId: "BR" },
        { optionName: "Bulgaria", optionId: "BG" },
        { optionName: "Burkina Faso", optionId: "BF" },
        { optionName: "Burundi", optionId: "BI" },
        { optionName: "Cameroon", optionId: "CM" },
        { optionName: "Canada", optionId: "CA" },
        { optionName: "Cape Verde", optionId: "CV" },
        { optionName: "Chile", optionId: "CL" },
        { optionName: "China", optionId: "CN" },
        { optionName: "Colombia", optionId: "CO" },
        { optionName: "Congo", optionId: "CG" },
        { optionName: "Congo, the Democratic Republic of the", optionId: "CD" },
        { optionName: "Costa Rica", optionId: "CR" },
        { optionName: "Côte d'Ivoire", optionId: "CI" },
        { optionName: "Croatia", optionId: "HR" },
        { optionName: "Curaçao", optionId: "CW" },
        { optionName: "Cyprus", optionId: "CY" },
        { optionName: "Czech Republic", optionId: "CZ" },
        { optionName: "Denmark", optionId: "DK" },
        { optionName: "Ecuador", optionId: "EC" },
        { optionName: "Egypt", optionId: "EG" },
        { optionName: "Estonia", optionId: "EE" },
        { optionName: "Faroe Islands", optionId: "FO" },
        { optionName: "Finland", optionId: "FI" },
        { optionName: "France", optionId: "FR" },
        { optionName: "Gabon", optionId: "GA" },
        { optionName: "Gibraltar", optionId: "GI" },
        { optionName: "Gambia", optionId: "GM" },
        { optionName: "Georgia", optionId: "GE" },
        { optionName: "Germany", optionId: "DE" },
        { optionName: "Ghana", optionId: "GH" },
        { optionName: "Greece", optionId: "GR" },
        { optionName: "Grenada", optionId: "GD" },
        { optionName: "Guinea", optionId: "GN" },
        { optionName: "Guyana", optionId: "GY" },
        { optionName: "Honduras", optionId: "HN" },
        { optionName: "Hungary", optionId: "HU" },
        { optionName: "Iceland", optionId: "IS" },
        { optionName: "Iran, Islamic Republic of", optionId: "IR" },
        { optionName: "Israel", optionId: "IL" },
        { optionName: "Italy", optionId: "IT" },
        { optionName: "Jamaica", optionId: "JM" },
        { optionName: "Japan", optionId: "JP" },
        { optionName: "Kenya", optionId: "KE" },
        { optionName: "Korea, Republic of", optionId: "KR" },
        { optionName: "Latvia", optionId: "LV" },
        { optionName: "Liberia", optionId: "LR" },
        { optionName: "Lithuania", optionId: "LT" },
        {
          optionName: "Macedonia, the Former Yugoslav Republic of",
          optionId: "MK",
        },
        { optionName: "Mali", optionId: "ML" },
        { optionName: "Mexico", optionId: "MX" },
        { optionName: "Montenegro", optionId: "ME" },
        { optionName: "Montserrat", optionId: "MS" },
        { optionName: "Morocco", optionId: "MA" },
        { optionName: "Netherlands", optionId: "NL" },
        { optionName: "New Zealand", optionId: "NZ" },
        { optionName: "Nigeria", optionId: "NG" },
        { optionName: "Norway", optionId: "NO" },
        { optionName: "Oman", optionId: "OM" },
        { optionName: "Pakistan", optionId: "PK" },
        { optionName: "Palestine, State of", optionId: "PS" },
        { optionName: "Paraguay", optionId: "PY" },
        { optionName: "Peru", optionId: "PE" },
        { optionName: "Philippines", optionId: "PH" },
        { optionName: "Poland", optionId: "PL" },
        { optionName: "Portugal", optionId: "PT" },
        { optionName: "Romania", optionId: "RO" },
        { optionName: "Russian Federation", optionId: "RU" },
        { optionName: "Saint Kitts and Nevis", optionId: "KN" },
        { optionName: "Senegal", optionId: "SN" },
        { optionName: "Serbia", optionId: "RS" },
        { optionName: "Seychelles", optionId: "SC" },
        { optionName: "Sierra Leone", optionId: "SL" },
        { optionName: "Slovakia", optionId: "SK" },
        { optionName: "Slovenia", optionId: "SI" },
        { optionName: "Sao Tome And Principe", optionId: "ST" },
        { optionName: "South Africa", optionId: "ZA" },
        { optionName: "Spain", optionId: "ES" },
        { optionName: "Sweden", optionId: "SE" },
        { optionName: "Switzerland", optionId: "CH" },
        { optionName: "Togo", optionId: "TG" },
        { optionName: "Trinidad and Tobago", optionId: "TT" },
        { optionName: "Tunisia", optionId: "TN" },
        { optionName: "Turkey", optionId: "TR" },
        { optionName: "Ukraine", optionId: "UA" },
        { optionName: "United States", optionId: "US" },
        { optionName: "Uruguay", optionId: "UY" },
        { optionName: "Venezuela, Bolivarian Republic of", optionId: "VE" },
        { optionName: "Zambia", optionId: "ZM" },
        { optionName: "Zimbabwe", optionId: "ZW" },
      ],
    }),
      (a.widgetConfig = []);
    let e = function (e, t) {
        (a.filterData.comps = e),
          o(),
          a.widgetConfig && a.widgetConfig[t] && a.widgetConfig[t]();
      },
      t = function (e) {
        let t = [];
        return (
          e.forEach(function (e) {
            a.filterData.comps.primary[e] &&
              t.push(a.filterData.comps.primary[e]);
          }),
          [].concat.apply([], t)
        );
      };
    a.filterData.getCurrentCompSeasonId = function (e) {
      return a.filterData.comps.all.filter(
        a.defaultData.checkId,
        parseInt(e)
      )[0].compSeasons[0].id;
    };
    const i = "2014-01-01";
    (a.filterData.getCompetitionStartDate = function (e) {
      ...
      (a.filterData.getAllCompSeasonIds = function (e) {
        let t = a.filterData.comps.all.filter(
            a.defaultData.checkId,
            parseInt(e)
          )[0],
          i = "";
        for (let a = 0; a < t.compSeasons.length; a++)
          i.length > 0 && (i += ","), (i += t.compSeasons[a].id);
        return i;
      });
    var o = function () {
      (a.filterGroups.matchHighlights = [
        ...
        },
        {
          ...
          dataUrl:
            a.environment.api +
            "/football/teams?page=0&pageSize=100&altIds=true&comps={{FOOTBALL_COMPETITION}}&compSeasons={{COMPSEASON}}",
        ...
        (a.filterGroups.editorial = [
          {
            ...
            dataIdPath: ["optionId"],
            data: [
              { optionLabel: "awards", optionId: "Awards" },
              { optionLabel: "broadcast", optionId: "Broadcasting" },
              { optionLabel: "communities", optionId: "Communities" },
              { optionLabel: "fantasy", optionId: "Fantasy" },
              { optionLabel: "fixtures", optionId: "fixtures" },
              { optionLabel: "mediaRelease", optionId: "Media Release" },
              { optionLabel: "talkingTactics", optionId: "Talking tactics" },
              { optionLabel: "transfers", optionId: "Transfers" },
              { optionLabel: "youth", optionId: "Youth" },
            ],
            dependencies: [],
            urlParameter: "type",
          },
        ...
        (a.filterGroups.milestones = [
          {
            ...
            data: [
              ...
              { optionLabel: "goals", optionId: "Oracle - Milestone - goals" },
              {
                optionLabel: "assists",
          ...
          },
          {
            ...
            dataUrl:
              ...
              a.filterData.comps.primary.FIRST.id +
              "/compseasons?page=0&pageSize=100&startDate=2022-01-01",
            dataListPath: ["content"],
            dataNamePath: ["label"],
            dataIdPath: ["id"],
            dependencies: [],
        ...
        (a.filterGroups.video = [
          {
            ...
            dataUrl:
              a.environment.api +
              "/football/teams?page=0&pageSize=100&altIds=true&comps=" +
              a.filterData.comps.primary.FIRST.id +
              "&compSeasons=" +
              a.filterData.getCurrentCompSeasonId(
                a.filterData.comps.primary.FIRST.id
              ),
            dependencies: [],
            urlParameter: "cl",
          },
          {
            ...
            dataUrl:
              a.environment.api +
              "/football/teams/{{FOOTBALL_CLUB}}/compseasons/" +
              a.filterData.getCurrentCompSeasonId(
                a.filterData.comps.primary.FIRST.id
              ) +
              "/staff",
        ...
        (a.filterGroups.yourClubVideo = [
          {
            ...
            data: [
              { optionLabel: "awards", optionId: "Awards" },
              { optionLabel: "bestgoals", optionId: "Best Goals" },
              { optionLabel: "bestsaves", optionId: "Best Saves" },
              { optionLabel: "classicmatch", optionId: "Classic Match" },
              { optionLabel: "communities", optionId: "Communities" },
              { optionLabel: "fantasy", optionId: "Fantasy" },
              { optionLabel: "goaloftheday", optionId: "Goal of the Day" },
              { optionLabel: "iconicmoment", optionId: "Iconic Moment" },
              { optionLabel: "onthisday", optionId: "On This Day" },
              { optionLabel: "trickbox", optionId: "Trickbox" },
              { optionLabel: "youth", optionId: "Youth" },
            ],
            dependencies: [],
            urlParameter: "type",
          },
          {
            ...
            dataUrl:
              ...
              "/football/competitions/" +
              a.filterData.comps.primary.FIRST.id +
              "/compseasons?page=0&pageSize=100",
            dataListPath: ["content"],
            dataNamePath: ["label"],
            dataIdPath: ["id"],
            dependencies: [],
        ...
        (a.filterGroups.allVideos = [
          ...
          },
          {
            ...
            dataUrl:
              a.environment.api +
              "/football/teams?page=0&pageSize=100&altIds=true&compSeasons={{FOOTBALL_COMPSEASON}}",
        ...
        (a.filterGroups.players = [
          ...
          },
          {
            ...
            dataUrl:
              a.environment.api +
              "/football/teams?page=0&pageSize=100&altIds=true&compSeasons={{compSeasons}}",
        ...
        (a.filterGroups.managers = [
          {
            ...
            label: "filterbyseason",
            defaultOption: "allseasons",
            defaultOptionId: a.filterData.getCurrentCompSeasonId(
              a.filterData.comps.primary.FIRST.id
            ),
            dataUrl:
              a.environment.api +
        ...
        (a.filterGroups.referee.appointments = [
          {
            ...
            dataListPath: ["content"],
            dataNamePath: ["label"],
            defaultId: a.filterData.getCurrentCompSeasonId(
              a.filterData.comps.primary.FIRST.id
            ),
            dataIdPath: ["id"],
            dependencies: [],
          ...
          },
          {
            ...
            listTransform: function (e) {
              return e.map(function (e) {
                return (
                  (e.MatchDays = a.common.momentGetDaysFromRange(
                    e.from.millis,
                    e.until.millis,
                    "ddd Do MMM",
                    !0
                  )),
                  (e.gameweekRange = "1-" + e.gameweek),
                  e
                );
              });
            },
        ...
        (a.filterGroups.seasonawards = [
          {
            ...
            urlParameter: "at",
            data: [
              { optionLabel: "award.MONTH", optionId: 1 },
              { optionLabel: "award.SEASON", optionId: 2 },
            ],
          },
          {
            name: "awards",
            ...
            data: [
              ...
              { optionLabel: "award.PLAYMAKER", optionId: 25, class: "Season" },
              {
        ...
        (a.filterGroups.awardtable = [
          {
            ...
            data: [
              ...
              { optionLabel: "award.YOUNG_PLAYER_OF_THE_SEASON", optionId: 26 },
              { optionLabel: "award.GOLDEN_BOOT", optionId: 23 },
              { optionLabel: "award.GOLDEN_GLOVE", optionId: 22 },
              { optionLabel: "award.PLAYMAKER", optionId: 25 },
              { optionLabel: "award.SAVE_OF_THE_MONTH", optionId: 14 },
              { optionLabel: "award.SAVE_OF_THE_SEASON", optionId: 27 },
            ],
            urlParameter: "aw",
          },
        ]),
        ...
        (a.filterGroups.rankedstats = {
          player: [
            ...
            },
            {
              ...
              dataUrl:
                a.environment.api +
                "/football/compseasons/{{FOOTBALL_COMPSEASON}}/teams",
              dependencies: ["FOOTBALL_COMPSEASON"],
              urlParameter: "cl",
              apiParam: "teams",
            },
            ...
            },
            {
              ...
              listTransform: function (a, e, t) {
                return (
                  "clean_sheet" ===
                    t.container.previousElementSibling.firstElementChild.getAttribute(
                      "data-metric"
                    ) &&
                    ((e.style.display = "none"),
                    (t.autoInitStateId = "GOALKEEPER")),
                  a
                );
              },
              urlParameter: "po",
          ...
          "player-pl2": [
            ...
            },
            {
              ...
              dataUrl:
                a.environment.api +
                "/football/competitions/{{FOOTBALL_COMPETITION}}/compseasons?page=0&pageSize=100",
              dataListPath: ["content"],
              dataNamePath: ["label"],
              dataIdPath: ["id"],
              listTransform: function (a, e, t) {
          ...
          "player-u18": [
            {
              ...
              data: [
                { label: "2019/20", id: 296 },
                { label: "2018/19", id: 220 },
                { label: "2017/18", id: 89 },
                { label: "2016/17", id: 60 },
              ],
              dataListPath: [],
        ...
        (a.filterGroups.stats = {
          player: [
            ...
            },
            {
              ...
              dataNamePath: ["label"],
              dataIdPath: ["id"],
              listTransform: function (e, t, i) {
                let o = parseInt(i.dependencyMap.FOOTBALL_COMPETITION.id);
                return (
                  (i.config.defaultOption = "All Seasons"),
                  a.filterData.comps.primary.U21.forEach(function (t) {
                    t.id === o &&
                      ((i.config.defaultOption = ""),
                      (e = e.filter(function (e) {
                        return a.statCompSeasons.U21.indexOf(e.id) > -1;
                      })));
                  }),
                  a.filterData.comps.primary.U18.id === o &&
                    ((i.config.defaultOption = ""),
                    (e = e.filter(function (e) {
        ...
        (a.filterGroups.Tables = {
          FIRST: [
            ...
            },
            {
              ...
              dataIdPath: ["id"],
              listTransform: function (a, e, t) {
                return 1 === parseInt(t.dependencyMap.FOOTBALL_COMPETITION.id)
                  ? [{ label: "All Seasons", id: -1 }].concat(a)
                  : a;
              },
              dependencies: ["FOOTBALL_COMPETITION"],
              depMethods: [
            ...
            },
            {
              ...
              listTransform: function (e, t, i) {
                return (
                  1 !== parseInt(i.dependencyMap.FOOTBALL_COMPETITION.id)
              ...
              dataUrl:
                a.environment.api +
                "/football/compseasons/{{compSeasons}}/gameweeks",
            ...
            },
            {
              ...
              listTransform: function (a, e, t) {
                return (
                  1 !== parseInt(t.dependencyMap.FOOTBALL_COMPETITION.id)
                    ? (e.style.display = "none")
                    : (e.style.display = ""),
                  a
                );
          ...
          U21: [
            ...
            },
            {
              ...
              dataNamePath: ["label"],
              defaultId: a.filterData.getCurrentCompSeasonId(
                a.filterData.comps.primary.U21[0].id
              ),
              dataIdPath: ["id"],
              dependencies: ["FOOTBALL_COMPETITION"],
              urlParameter: "se",
          ...
          U18: [
            ...
            },
            {
              ...
              dataNamePath: ["label"],
              defaultId: a.filterData.getCurrentCompSeasonId(
                a.filterData.comps.primary.U18.id
              ),
              dataIdPath: ["id"],
              dependencies: ["FOOTBALL_COMPETITION"],
              urlParameter: "se",
        ...
        (a.filterGroups.Results = {
          FIRST: [
            ...
            },
            {
              ...
              dataUrl:
                a.environment.api +
                "/football/competitions/{{comps}}/compseasons?page=0&pageSize=100&startDate={{START_DATE}}",
              dataListPath: ["content"],
              dataNamePath: ["label"],
              dataIdPath: ["id"],
              dependencies: ["comps"],
              depMethods: [
                { dep: "comps", default: a.filterData.comps.primary.FIRST.id },
                {
                  label: "START_DATE",
                  method: "getCompetitionStartDate",
                  dep: "comps",
              ...
              listTransform: function (a, e, t) {
                return (
                  parseInt(t.dependencyMap.comps.id) < 0
                    ? (e.style.display = "none")
                    : (e.style.display = ""),
                  a
                );
            ...
            },
            {
              ...
              dataUrl:
                a.environment.api +
                "/football/compseasons/{{compSeasons}}/teams",
              dependencies: ["compSeasons"],
              urlParameter: "cl",
            },
          ],
        ...
        (a.filterGroups.Fixtures = {
          FIRST: [
            ...
            },
            {
              ...
              dataUrl:
                a.environment.api +
                "/football/compseasons/{{COMPSEASON}}/teams",
              dependencies: ["comps"],
              urlParameter: "cl",
            },
          ],
        ...
        (a.filterGroups.embeddableBroadcasters = [
          {
            ...
            dataUrl:
              a.environment.api + "/football/broadcasting-schedule/countries",
            urlParameter: "iso",
        ...
        (a.filterGroups.broadcasters = [
          ...
          },
          {
            ...
            dataUrl:
              a.environment.api + "/football/compseasons/{{COMPSEASON}}/teams",
            dependencies: ["comps"],
            urlParameter: "cl",
          },
        ]),
        (a.filterGroups.playerComparison = [
          ...
          },
          {
            ...
            dataIdPath: ["optionId"],
            data: [
              { optionLabel: "goalkeeper", optionId: "G" },
              { optionLabel: "defender", optionId: "D" },
              { optionLabel: "midfielder", optionId: "M" },
              { optionLabel: "forward", optionId: "F" },
            ],
            listTransform: function () {},
            urlParameter: "po",
            apiParam: "positions",
        ...
        (a.filterGroups.awards = [
          ...
          },
          {
            ...
            listTransform: function (a, e, t) {
              return (
                t.dependencyMap.compSeasons.id > 0
                  ? (e.style.display = "none")
                  : (e.style.display = ""),
                a
              );
        ...
        (a.filterGroups.kotmPlayerStats = [
          ...
          },
          {
            ...
            dataIdPath: ["id"],
            dataUrl:
              a.environment.api + "/football/compseasons/{{compSeasons}}/teams",
            dependencies: ["compSeasons"],
            urlParameter: "cl",
            apiParam: "teams",
          },
          {
            ...
            dataIdPath: ["optionId"],
            data: [
              { optionLabel: "kotm.nominations", optionId: "nominations" },
            ],
            urlParameter: "stat",
            apiParam: "stat",
          },
        ...
        (a.filterGroups.hallOfFame = [
          {
            ...
            dataIdPath: ["optionId"],
            data: [
              { optionLabel: "2024", optionId: "2024" },
              { optionLabel: "2023", optionId: "2023" },
              { optionLabel: "2022", optionId: "2022" },
              { optionLabel: "2021", optionId: "2021" },
            ],
            dependencies: [],
            urlParameter: "type",
          },
          {
            ...
            dataIdPath: ["optionId"],
            data: [
              { optionLabel: "manager", optionId: "Ma" },
              { optionLabel: "goalkeeper", optionId: "G" },
              { optionLabel: "defender", optionId: "D" },
              { optionLabel: "midfielder", optionId: "M" },
              { optionLabel: "forward", optionId: "F" },
    ...
    a.filterGroups = {
      setData: function (t) {
        a.widgetConfig.push(t), a.defaultData.get(e, a.widgetConfig.length - 1);
      },
    };
  })(PULSE.app, PULSE.app.common),
  (PULSE.app.countryCodes = {
    AF: "Afghanistan",
    AL: "Albania",
    DZ: "Algeria",
    AS: "American Samoa",
      ...
      i = function (a, e) {
        ...
        for (let i = 0; i < a.length; i++)
          for (let o = 0; o < e.length; o++)
            e[o].id === parseInt(a[i]) && t.push(e[o]);
        return t;
      },
      o = function (o, n) {
        !(function () {
          let o = {
            url:
              a.environment.api +
              "/football/competitions?page=0&pageSize=1000&detail=2",
            target: this,
            method: "GET",
            callback: function (e) {
              t = {
                all: e.content,
                FIRST: i(a.competitions.FIRST, e.content),
                U21: i(a.competitions.U21, e.content),
                U18: i(a.competitions.U18, e.content),
              };
              let o = t.FIRST.concat(t.U21).concat(t.U18);
              (t.pl = {
                FIRST: { ids: a.competitions.FIRST, comps: t.FIRST },
                U21: { ids: a.competitions.U21, comps: t.U21 },
                U18: { ids: a.competitions.U18, comps: t.U18 },
                all: { ids: a.competitions.PL, comps: o },
              }),
                (t.primary = {
                  FIRST: t.FIRST[0],
          ...
          e.data.manager.add(o);
        })();
        var r = setInterval(function () {
          t &&
            (o(t, n),
            clearInterval(r),
            e.localStorage.setStorage("defaultData", JSON.stringify(t), 1));
        }, 500);
      };
    (a.defaultData = {
      get: function (a, e) {
  ...
  (function (a, e) {
    (a.I18N = {}),
      (a.I18N.setup = function () {
        let t = e.localStorage.getStorage("req_language", !0);
        a.language = t || a.defaultLanguage;
        let i = new a.I18N.Translator(PULSE.I18N);
        PULSE.I18N || (PULSE.I18N = {}),
          (PULSE.I18N.lookup = function () {
            return i.lookup.apply(i, arguments);
          }),
          void 0 !== window.moment &&
            (a.I18N.enOverride(), moment.locale(a.language));
      }),
          ...
          e
            ? ((t.hasTranslations = !0),
              t.language !== e.language &&
                (void 0 === e.language &&
                  console.log("Language mismatch! Using " + e.language),
                (t.language = e.language)),
              (t.translations = e.translations || {}),
              (t.hasTranslations = !0))
            : ((t.hasTranslations = !1), (t.translations = {}));
      }),
  ...
  (PULSE.app.loadTimezones = function () {
    moment.tz.load({
      version: "2016f",
      zones: [
  ...
  (function (a, e) {
    function t() {
      const a = 0.01 * window.innerHeight;
  ...
  (function (a) {
    (a.templating = {}),
      (a.templating.helper = {}),
      (a.templating.render = function () {
        let t =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          i = arguments.length > 1 ? arguments[1] : void 0,
          o = arguments.length > 2 ? arguments[2] : void 0,
          n = "";
        for (let e in a.templating)
          a.templating.hasOwnProperty(e) && (t[e] = a.templating[e]);
        if (
          ((t.environment = a.environment),
          (t.helper.date = a.common.date),
          (t.helper.template = a.common.template),
          (t.helper.image = a.common.image),
          i)
        ) {
          let r = a.templates[i];
          if (r) {
            try {
              ...
              a.message && (a.message += " in template " + i),
                console.warn(a),
                console.info("Model given", t);
            }
            if (o) return e(n);
          } else
            console.warn("No template was rendered. Template not found: " + i);
        }
        return n;
      });
    const e = (a) => {
  ...
  (function (a) {
    ...
    (a.tracking = {}),
      (a.tracking.getSiteDetails = function () {
        const t = a.tracking.getPageName(),
          i = window.location.search || "",
          o =
            window.location.pathname.replace(/\/+/g, "/").split("/")[1] ||
            "home",
          n = e() || o.replace("-", " ") || "home";
        return {
          pageName: t,
          ...
          contentType: n,
          platformType:
            window.outerWidth > a.measurements.tablet ? "desktop" : "mobile",
  ...
  (function (a, e, t) {
    a.webView = function () {
      var i = e.url.getParam("webview"),
        o = e.url.getParam("webview_cookie");
      o &&
        "true" === o &&
        e.localStorage.setStorage(
          a.cookiePrefix + "webviewCookie",
          !0,
          100,
          !0
        );
      ...
      if (
        ...
        s && void 0 !== window.tcfCmp && void 0 !== window.tcfCmp.ui
          ? (window.tcfCmp.ui.closeModal(), s.remove())
          : s && window.tcfCmp.ui && window.tcfCmp.ui.overlay
          ? (window.tcfCmp.ui.overlay.remove(), s.remove())
          : s && s.remove(),
        l && (l.style.display = "none"),
        e.style.addClass(document.body, "webViewBody"),
        t.tracking)
      ) {
        var d = t.tracking.getHeader("user-platform");
        d && t.tracking.googleTrack(d);
      }
    };
  ...
  (function (a) {
    const e = { root: null, rootMargin: "0px", threshold: [0.1, 0.9] };
    let t;
    a.widgetInitialiser = {};
    const i = {};
    (a.widgetInitialiser.addWidget = (e, t) => {
      let i = t || a[r(e)],
        o = document.querySelector(`[data-widget="${e}"]`);
      o && "true" !== o.dataset.initialized && n(e, o, i);
    }),
      (a.widgetInitialiser.addMultipleWidgetsByName = (e, t, i) => {
        let o = i || document,
          s = t || a[r(e)],
          l = o.querySelectorAll(`[data-widget="${e}"]`);
        for (let a = 0; a < l.length; a++) n(e, l[a], s);
      }),
      (a.widgetInitialiser.addWidgets = (e) => {
        let t = (e || document).querySelectorAll("[data-widget]");
        for (let e = 0; e < t.length; e++) {
          let i = t[e].getAttribute("data-constructor"),
            o = t[e].getAttribute("data-widget");
          !i && o && (i = r(o)), a.hasOwnProperty(i) && n(o, t[e], a[i]);
        }
      });
    const o = (e) => {
        const o = i[e.dataset.observableId];
        if (o) {
          const n = e.dataset.widget,
            r = new o(e);
          "true" === e.dataset.storeReference && a.widgets[n].push(r),
            e.setAttribute("data-initialised", !0),
            delete i[e.dataset.observableId],
            void 0 !== t && t.unobserve(e);
        } else console.warn("Observing unexpected widget", e);
      },
      n = (n, r, l) => {
        if ("true" !== r.getAttribute("data-initialised"))
          if (
            (a.widgets[n] || (a.widgets[n] = []),
            "true" === r.dataset.initWhenVisible &&
              (() => {
                if (void 0 === t) {
            ...
            const a = s(n);
            (i[a] = l), (r.dataset.observableId = a), t.observe(r);
          } else {
            const e = new l(r);
            "true" === r.dataset.storeReference && a.widgets[n].push(e),
              r.setAttribute("data-initialised", !0);
          }
      },
      r = (a) =>
        a.toLowerCase().replace(/(\b|-)\w/g, function (a) {

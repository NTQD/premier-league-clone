...
!(function (t, a) {
  (t.GenericTabsNav = function (t) {
    ...
    (t.GenericTabsNav.prototype.setMoreDropdown = function (t) {
      let e = { navWrap: t, moreLabel: "More", activeClass: "is-active" };
      new a.moreNav(e);
    });
  document
    .querySelectorAll('[data-widget="generic-tabs-nav"]')
    .forEach((a) => new t.GenericTabsNav(a));
})(PULSE.app, PULSE.ui),
  (function (t, a, e, l, b) {
    t.homeTabs = function (t, e) {
      let l = this;
      (l.tabMatches = b.lookup("label.hometab.matches")),
        (l.tabLatest = b.lookup("label.hometab.latest"));
      let n = {
        tabItems: (function () {
          let t = [],
          ...
          return (
            b.setAttribute("data-ui-tab", l.tabMatches),
            t.push.apply(t, [e, b]),
            t
          );
        })(),
    ...
    (t.tabbedContent = function (l, b) {
      let n = this,
        o = function (t) {
          return (
            ...
            "#comment" !== t.nodeName &&
              null !== t.getAttribute &&
              t.getAttribute("data-ui-tab")
          );
        },
        r = [];
      (r = b.tabClass
        ? document.getElementsByClassName(b.tabClass)
        : e.dom.getNextSiblings(l, o)),
        0 === r.length && (r = document.querySelectorAll("[data-ui-tab]")),
        (t.updateTabParam = b.updateTabParam);
      let i = {
        tabItems: r,
      ...
      if (u)
        for (let a = 0; a < n.tabs.config.tabItems.length; a++)
          if (
            n.tabs.config.tabItems[a]
              .getAttribute("data-filter-list")
              .toLowerCase() === u.toLowerCase()
          ) {
            n.tabs.showTabByIndex(a),
              setTimeout(function () {
      ...
      (t.globalTabbedContentBuildCallback = function (t) {
        t.config.tabs.forEach((t) => {
          ...
          t.config.current.content.setAttribute(
            "data-tab-aware-default",
            "true"
          );
      }),
      (t.globalTabbedContentCallback = function (a, l) {
        if (
          (t.tabAwareWidgets &&
            t.tabAwareWidgets.length &&
            t.tabAwareWidgets.map(function (t) {
          ...
          for (let a = 0; a < t.length; a++)
            if (e.style.hasClass(t[a], "active")) {
              let l = e.url.updateUrlStringParam(
                window.location.href,
                "team",
                t[a].getAttribute("data-filter-list")
              );

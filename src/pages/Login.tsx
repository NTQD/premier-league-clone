      ...
      <Container maxWidth="lg">
        ...
        <Paper elevation={2} sx={{ p: 0, borderRadius: 2 }}>
          <Tabs value={tab} onChange={(_, v) => setTab(v)} sx={{ mb: 0, borderBottom: '2px solid #ff0060' }}>
            ...
            <Tab label="Register" sx={{ fontWeight: 700, color: tab === 1 ? '#fff' : '#37003c', bgcolor: tab === 1 ? '#ff0060' : 'transparent', borderRadius: 0, minWidth: 120 }} disabled />
          </Tabs>
          <Grid container>
            {/* Left: Login Form */}
            ...
            <Grid item xs={12} md={5} sx={{ p: 4, bgcolor: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Box sx={{ width: '100%', maxWidth: 350 }}>
                ...
                <Button variant="contained" fullWidth sx={{ bgcolor: '#ff0060', color: '#fff', fontWeight: 700, fontSize: 18, py: 1.2, borderRadius: 1, mt: 2, '&:hover': { bgcolor: '#d90050' } }}>Register</Button>
              </Box>
            </Grid>
          </Grid>
        </Paper>
